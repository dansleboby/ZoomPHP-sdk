...
/**
 * GroupListAllOf Class Doc Comment
 *
 * @category Class
 ...
 */
class GroupListAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Group_List_allOf';
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling GroupListAllOf., must be smaller than or equal to 300.');
        }
