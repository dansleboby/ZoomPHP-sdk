...
/**
 * GetGroupSettings200ResponseOneOfInMeetingWebinarChat Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class GetGroupSettings200ResponseOneOfInMeetingWebinarChat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getGroupSettings_200_response_oneOf_in_meeting_webinar_chat';
     ...
     *
     * @param int|null $allow_users_save_chats Whether to allow webinar attendees to save chats: * `0` — Attendees cannot save chats. * `1` — Attendees can only save host and panelist chats. * `2` — Attendees can save all chats.
     *
     * @return self
     */
