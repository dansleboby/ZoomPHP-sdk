...
class MeetingList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MeetingList';
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling MeetingList., must be smaller than or equal to 300.');
        }
     ...
     * Sets meetings
     *
     * @param object[]|null $meetings List of Meeting objects.
     *
     * @return $this
     */
