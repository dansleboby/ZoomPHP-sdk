...
class InlineObject7 implements ModelInterface, ArrayAccess
{
     ...
     * Sets name
     *
     * @param string|null $name Name of the channel.
     *
     * @return $this
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject7., must be smaller than or equal to 128.');
        }
     ...
     * Gets members
     *
     * @return \Zoom\Api\Model\ChatUsersUserIdChannelsMembers[]|null
     */
     ...
     * Sets members
     *
     * @param \Zoom\Api\Model\ChatUsersUserIdChannelsMembers[]|null $members Member(s) to include in the channel. A max of 5 members can be added to the channel at once with this API.
     *
     * @return $this
     */
