...
class MeetingsApi
{
    ...
    /**
     * Operation inMeetingRecordingControl
     *
     * Use In-Meeting Recording Controls
     *
     * @param  string $meeting_id Unique identifier of the live meeting. (required)
     * @param  \Zoom\Api\Model\InlineObject84 $body body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function inMeetingRecordingControl($meeting_id, $body = null)
    {
        list($response) = $this->inMeetingRecordingControlWithHttpInfo($meeting_id, $body);
        return $response;
    }

    /**
     * Operation inMeetingRecordingControlWithHttpInfo
     *
     * Use In-Meeting Recording Controls
     *
     * @param  string $meeting_id Unique identifier of the live meeting. (required)
     * @param  \Zoom\Api\Model\InlineObject84 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function inMeetingRecordingControlWithHttpInfo($meeting_id, $body = null)
    {
        $request = $this->inMeetingRecordingControlRequest($meeting_id, $body);
    ...
    /**
     * Operation inMeetingRecordingControlAsync
     *
     * Use In-Meeting Recording Controls
     *
     * @param  string $meeting_id Unique identifier of the live meeting. (required)
     ...
     */
    public function inMeetingRecordingControlAsync($meeting_id, $body = null)
    {
        return $this->inMeetingRecordingControlAsyncWithHttpInfo($meeting_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation inMeetingRecordingControlAsyncWithHttpInfo
     *
     * Use In-Meeting Recording Controls
     *
     * @param  string $meeting_id Unique identifier of the live meeting. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inMeetingRecordingControlAsyncWithHttpInfo($meeting_id, $body = null)
    {
        $returnType = 'object';
        $request = $this->inMeetingRecordingControlRequest($meeting_id, $body);
     ...
     */
    protected function inMeetingRecordingControlRequest($meeting_id, $body = null)
    {
        // verify the required parameter 'meeting_id' is set
        if ($meeting_id === null || (is_array($meeting_id) && count($meeting_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $meeting_id when calling inMeetingRecordingControl'
            );
        }
    ...
    public function listPastMeetingPollsWithHttpInfo($meeting_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20083' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20083', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function meetingWithHttpInfo($meeting_id, $occurrence_id = null, $show_previous_occurrences = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20022' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20022', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    protected function meetingRequest($meeting_id, $occurrence_id = null, $show_previous_occurrences = null)
    {
        ...
        // query params
        if (is_array($occurrence_id)) {
            $occurrence_id = ObjectSerializer::serializeCollection($occurrence_id, '', true);
        }
        if ($occurrence_id !== null) {
            $queryParams['occurrence_id'] = $occurrence_id;
        }
        // query params
        if (is_array($show_previous_occurrences)) {
            $show_previous_occurrences = ObjectSerializer::serializeCollection($show_previous_occurrences, '', true);
        }
        if ($show_previous_occurrences !== null) {
            $queryParams['show_previous_occurrences'] = $show_previous_occurrences;
        }
     ...
     * @param  \Zoom\Api\Model\InlineObject23 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $user_id The user ID or email address of the user. For user-level apps, pass &#x60;me&#x60; as the value for userId. (required)
     * @param  \Zoom\Api\Model\InlineObject23 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function meetingCreateWithHttpInfo($user_id, $body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Zoom\Api\Model\InlineResponse20111' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20111', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    protected function meetingDeleteRequest($meeting_id, $occurrence_id = null, $schedule_for_reminder = null)
    {
        ...
        // query params
        if (is_array($schedule_for_reminder)) {
            $schedule_for_reminder = ObjectSerializer::serializeCollection($schedule_for_reminder, '', true);
        }
        if ($schedule_for_reminder !== null) {
            $queryParams['schedule_for_reminder'] = $schedule_for_reminder;
        }
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject44 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject44 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject43 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject43 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body Meeting poll object (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function meetingPollCreateWithHttpInfo($meeting_id, $body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Zoom\Api\Model\InlineResponse20113' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20113', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  string $poll_id The poll ID (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body Meeting Poll (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body body (required)
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body (required)
     * @param  string $occurrence_ids Occurrence IDs. You can find these with the meeting get API. Multiple values separated by comma. (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function meetingRegistrantCreateWithHttpInfo($meeting_id, $body, $occurrence_ids = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Zoom\Api\Model\InlineResponse20112' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20112', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    protected function meetingRegistrantCreateRequest($meeting_id, $body, $occurrence_ids = null)
    {
        ...
        if (is_array($occurrence_ids)) {
            $occurrence_ids = ObjectSerializer::serializeCollection($occurrence_ids, '', true);
        }
        if ($occurrence_ids !== null) {
            $queryParams['occurrence_ids'] = $occurrence_ids;
        }
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body Meeting Registrant Questions (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject25 $body body (required)
     * @param  string $occurrence_id The meeting occurrence ID. (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject25 $body (required)
     * @param  string $occurrence_id The meeting occurrence ID. (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function meetingRegistrantsWithHttpInfo($meeting_id, $occurrence_id = null, $status = 'approved', $page_size = 30, $page_number = 1, $next_page_token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\RegistrationList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\RegistrationList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function meetingRegistrantsRequest($meeting_id, $occurrence_id = null, $status = 'approved', $page_size = 30, $page_number = 1, $next_page_token = null)
    {
        // verify the required parameter 'meeting_id' is set
        if ($meeting_id === null || (is_array($meeting_id) && count($meeting_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function meetingRegistrantsQuestionsGetWithHttpInfo($meeting_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20025' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20025', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject24 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject24 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body Meeting (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function meetingsRequest($user_id, $type = 'live', $page_size = 30, $next_page_token = null, $page_number = null)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function pastMeetingDetailsWithHttpInfo($meeting_uuid)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20023' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20023', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function pastMeetingParticipantsWithHttpInfo($meeting_uuid, $page_size = 30, $next_page_token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20024' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20024', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
