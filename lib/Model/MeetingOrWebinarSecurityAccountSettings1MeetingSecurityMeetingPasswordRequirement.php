...
/**
 * MeetingOrWebinarSecurityAccountSettings1MeetingSecurityMeetingPasswordRequirement Class Doc Comment
 *
 * @category Class
 ...
 */
class MeetingOrWebinarSecurityAccountSettings1MeetingSecurityMeetingPasswordRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Meeting_or_Webinar_Security_Account_Settings_1_meeting_security_meeting_password_requirement';
     ...
     * Sets have_letter
     *
     * @param bool|null $have_letter Whether the password must contain at least one letter character.
     *
     * @return self
     */
     ...
     * Sets have_number
     *
     * @param bool|null $have_number Whether the password must contain at least one numeric character.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $have_special_character Whether the password must contain at least one special character. For example, `!`, `@`, and/or `#` characters.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $have_upper_and_lower_characters Whether the password must include uppercase and lowercase characters.
     *
     * @return self
     */
     ...
     * Sets length
     *
     * @param int|null $length The password's minimum length.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $only_allow_numeric Whether the password must contain **only** numeric characters.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $weak_enhance_detection Whether users will be informed when the provided password is weak.
     *
     * @return self
     */
