...
class UserSettingsMeetingSettingsMeetingPasswordRequirement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'User settings Meeting settings_meeting_password_requirement';
     ...
     * Sets length
     *
     * @param int $length The minimum length that the meeting/webinar passcode needs to have.
     *
     * @return $this
     */
     ...
     * Sets have_letter
     *
     * @param bool $have_letter If set to `true`, the passcode must contain at least 1 letter (such as a,b,c...).
     *
     * @return $this
     */
     ...
     * Sets have_number
     *
     * @param bool $have_number If set to `true`, the passcode must contain at least 1 number (such as 1,2,3...).
     *
     * @return $this
     */
     ...
     *
     * @param bool $have_special_character If set to `true`, the passcode must have at least 1 special character (!,@,#...).
     *
     * @return $this
     */
     ...
     *
     * @param bool $only_allow_numeric If set to `true`, the passcode must only contain numbers and no other characters.
     *
     * @return $this
     */
     ...
     *
     * @param bool $have_upper_and_lower_characters If set to `true`, the passcode must include both uppercase and lowercase characters.
     *
     * @return $this
     */
     ...
     *
     * @param int $consecutive_characters_length consecutive_characters_length
     *
     * @return $this
     */
     ...
     *
     * @param bool $weak_enhance_detection If set to `true`, users will be informed if the provided passcode is weak.
     *
     * @return $this
     */
