...
/**
 * Listmeetingmetrics Class Doc Comment
 *
 * @category Class
 ...
 */
class Listmeetingmetrics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listmeetingmetrics';
    ...
    protected static $openAPITypes = [
        ...
        'start_time' => '\DateTime',
        'topic' => 'string',
        'tracking_fields' => '\Zoom\Api\Model\ListmeetingmetricsTrackingFieldsInner[]',
        'user_type' => 'string',
        'uuid' => 'string',
    ...
    public function setCustomKeys($custom_keys)
    {
        ...
        if (!is_null($custom_keys) && (count($custom_keys) > 10)) {
            throw new \InvalidArgumentException('invalid value for $custom_keys when calling Listmeetingmetrics., number of items must be less than or equal to 10.');
        }
     ...
     * Sets duration
     *
     * @param string|null $duration Meeting duration. Formatted as hh:mm:ss, for example: `16:08` for 16 minutes and 8 seconds.
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\ListmeetingmetricsTrackingFieldsInner[]|null
     */
     ...
     *
     * @param \Zoom\Api\Model\ListmeetingmetricsTrackingFieldsInner[]|null $tracking_fields Tracking fields and values assigned to the meeting.
     *
     * @return self
     */
     ...
     *
     * @param string|null $screen_share_quality The meeting's [screen share quality score](https://support.zoom.us/hc/en-us/articles/360061244651-Using-meeting-quality-scores-and-network-alerts):  * `good` — The video is almost flawless and the quality is excellent.  * `fair` — The video definition is high, occasionally gets stuck, fast or slow, or other problems, but the frequency is very low and the video quality is good.  * `poor` — The video definition is not high, but not many problems exist. The video quality is mediocre.  * `bad` — The picture is very blurred and often gets stuck.
     *
     * @return self
     */
