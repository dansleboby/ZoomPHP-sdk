...
class InlineResponse20092Assignee implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_92_assignee';
     ...
     * Sets id
     *
     * @param string|null $id Unique Identifier of the user to whom the number has been assigned.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the user to whom the number has been assigned.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $extension_number Extension number of the Phone.
     *
     * @return $this
     */
