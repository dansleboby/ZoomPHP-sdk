...
/**
 * GetGroupLockSettings200ResponseOneOfInMeeting Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class GetGroupLockSettings200ResponseOneOfInMeeting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getGroupLockSettings_200_response_oneOf_in_meeting';
     ...
     * Sets meeting_survey
     *
     * @param bool|null $meeting_survey Whether the host can present a survey to participants once a meeting has ended. This feature is only available in version 5.7.3 or higher.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $request_permission_to_unmute Indicates whether the [**Request permission to unmute participants**](https://support.zoom.us/hc/en-us/articles/203435537-Muting-and-unmuting-participants-in-a-meeting#h_01EGK4XFWS1SJGZ71MYGKF7260) option has been enabled and locked for the group or not.
     *
     * @return self
     */
     ...
     * Sets save_caption
     *
     * @param bool|null $save_caption Whether participants can save closed captions or transcripts.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $webinar_polling Whether the host can add polls before or during a webinar.
     *
     * @return self
     */
     ...
     * Sets webinar_survey
     *
     * @param bool|null $webinar_survey Whether the host can present surveys to attendees once a webinar has ended.
     *
     * @return self
     */
