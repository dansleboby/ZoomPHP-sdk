...
/**
 * GetZRAccountSettings200ResponseOneOf1DigitalSignage Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class GetZRAccountSettings200ResponseOneOf1DigitalSignage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getZRAccountSettings_200_response_oneOf_1_digital_signage';
    ...
    protected static $openAPITypes = [
        ...
        'display_period' => '\Zoom\Api\Model\GetZRAccountSettings200ResponseOneOf1DigitalSignageDisplayPeriod',
        'enable_digital_signage' => 'bool',
        'layout' => 'string',
        'mute' => 'bool',
        'play_list' => '\Zoom\Api\Model\GetZRAccountSettings200ResponseOneOf1DigitalSignagePlayListInner[]'
    ];
     ...
     * Gets display_period
     *
     * @return \Zoom\Api\Model\GetZRAccountSettings200ResponseOneOf1DigitalSignageDisplayPeriod|null
     */
     ...
     * Sets display_period
     *
     * @param \Zoom\Api\Model\GetZRAccountSettings200ResponseOneOf1DigitalSignageDisplayPeriod|null $display_period display_period
     *
     * @return self
     */
     ...
     * Gets play_list
     *
     * @return \Zoom\Api\Model\GetZRAccountSettings200ResponseOneOf1DigitalSignagePlayListInner[]|null
     */
     ...
     * Sets play_list
     *
     * @param \Zoom\Api\Model\GetZRAccountSettings200ResponseOneOf1DigitalSignagePlayListInner[]|null $play_list Content list.
     *
     * @return self
     */
    public function setPlayList($play_list)
    {
        ...
        if (!is_null($play_list) && (count($play_list) > 2)) {
            throw new \InvalidArgumentException('invalid value for $play_list when calling GetZRAccountSettings200ResponseOneOf1DigitalSignage., number of items must be less than or equal to 2.');
        }
