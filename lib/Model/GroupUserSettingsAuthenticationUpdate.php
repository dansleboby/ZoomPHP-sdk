 ...
 */
class GroupUserSettingsAuthenticationUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupUserSettingsAuthenticationUpdate';
