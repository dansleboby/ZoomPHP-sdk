...
class Body68 implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Body68., must be smaller than or equal to 32.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 32)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Body68., must be smaller than or equal to 32.');
        }
