...
/**
 * AccountUpdateSettingsScheduleMeetingMeetingPasswordRequirement Class Doc Comment
 *
 * @category Class
 ...
 */
class AccountUpdateSettingsScheduleMeetingMeetingPasswordRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountUpdateSettings_schedule_meeting_meeting_password_requirement';
     ...
     * Sets length
     *
     * @param int|null $length The minimum length that the meeting or webinar password must have.
     *
     * @return self
     */
