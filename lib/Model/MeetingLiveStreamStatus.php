 ...
 */
class MeetingLiveStreamStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MeetingLiveStreamStatus';
     ...
     * Sets action
     *
     * @param string|null $action Update the status of a live stream.  The value can be one of the following:<br> `start`: Start a live stream. <br> `stop`: Stop an ongoing live stream.
     *
     * @return self
     */
