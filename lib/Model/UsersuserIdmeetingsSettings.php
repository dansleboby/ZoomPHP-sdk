...
class UsersUserIdMeetingsSettings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_users__userId__meetings_settings';
     ...
     *
     * @param bool|null $join_before_host Allow participants to join the meeting before the host starts the meeting. This field can only used for scheduled or recurring meetings.  **Note:** If waiting room is enabled, the **join before host** setting will be disabled.
     *
     * @return $this
     */
     ...
     * Sets use_pmi
     *
     * @param bool|null $use_pmi Use Personal Meeting ID instead of an automatically generated meeting ID. It can only be used for scheduled meetings, instant meetings and recurring meetings with no fixed time.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $alternative_hosts Alternative host's emails or IDs: multiple values separated by a comma.
     *
     * @return $this
     */
     ...
     * Sets waiting_room
     *
     * @param bool|null $waiting_room Enable waiting room. Note that if the value of this field is set to `true`, it will override and disable the `join_before_host` setting.
     *
     * @return $this
     */
