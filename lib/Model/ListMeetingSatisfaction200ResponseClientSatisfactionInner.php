...
/**
 * ListMeetingSatisfaction200ResponseClientSatisfactionInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class ListMeetingSatisfaction200ResponseClientSatisfactionInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listMeetingSatisfaction_200_response_client_satisfaction_inner';
     ...
     *
     * @param double|null $satisfaction_percent Satisfaction Percentage. The satisfaction percentage is calculated as `(good_count + none_count)` / `total_count`.
     *
     * @return self
     */
