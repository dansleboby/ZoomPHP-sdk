...
/**
 * DashboardIM200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class DashboardIM200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dashboardIM_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'users' => '\Zoom\Api\Model\DashboardIM200ResponseAllOf1UsersInner[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling DashboardIM200Response., must be smaller than or equal to 300.');
        }
     ...
     * Gets users
     *
     * @return \Zoom\Api\Model\DashboardIM200ResponseAllOf1UsersInner[]|null
     */
     ...
     * Sets users
     *
     * @param \Zoom\Api\Model\DashboardIM200ResponseAllOf1UsersInner[]|null $users users
     *
     * @return self
     */
