...
class InlineResponse20027Participants implements ModelInterface, ArrayAccess
{
     ...
     * Sets leave_time
     *
     * @param \DateTime $leave_time The time at which a participant left the meeting. For live meetings, this field will only be returned if a participant has left the ongoing meeting.
     *
     * @return $this
     */
