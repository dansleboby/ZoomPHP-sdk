...
/**
 * CreateBatchPollsRequestPollsInnerQuestionsInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class CreateBatchPollsRequestPollsInnerQuestionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createBatchPolls_request_polls_inner_questions_inner';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['rating_min_value']) && ($this->container['rating_min_value'] < 1)) {
            $invalidProperties[] = "invalid value for 'rating_min_value', must be bigger than or equal to 1.";
        }
    ...
    public function setAnswerMinCharacter($answer_min_character)
    {
        ...
        if (!is_null($answer_min_character) && ($answer_min_character < 1)) {
            throw new \InvalidArgumentException('invalid value for $answer_min_character when calling CreateBatchPollsRequestPollsInnerQuestionsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setAnswers($answers)
    {
        ...
        if (!is_null($answers) && (count($answers) < 2)) {
            throw new \InvalidArgumentException('invalid length for $answers when calling CreateBatchPollsRequestPollsInnerQuestionsInner., number of items must be greater than or equal to 2.');
        }
     ...
     * Sets name
     *
     * @param string|null $name The poll question's title, up to 255 characters.   For `fill_in_the_blank` polls, this field is the poll's question. For each value that the user must fill in, ensure that there are the same number of `right_answers` values.
     *
     * @return self
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateBatchPollsRequestPollsInnerQuestionsInner., must be smaller than or equal to 255.');
        }
    ...
    public function setRatingMaxValue($rating_max_value)
    {
        ...
        if (!is_null($rating_max_value) && ($rating_max_value > 10)) {
            throw new \InvalidArgumentException('invalid value for $rating_max_value when calling CreateBatchPollsRequestPollsInnerQuestionsInner., must be smaller than or equal to 10.');
        }
    ...
    public function setRatingMinValue($rating_min_value)
    {
        ...
        if (!is_null($rating_min_value) && ($rating_min_value < 1)) {
            throw new \InvalidArgumentException('invalid value for $rating_min_value when calling CreateBatchPollsRequestPollsInnerQuestionsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setRightAnswers($right_answers)
    {
        ...
        if (!is_null($right_answers) && (count($right_answers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $right_answers when calling CreateBatchPollsRequestPollsInnerQuestionsInner., number of items must be greater than or equal to 1.');
        }
