 ...
 */
class AccountSettingsInMeeting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountSettingsInMeeting';
    ...
    protected static $openAPITypes = [
        ...
        'chat' => 'bool',
        'closed_caption' => 'bool',
        'closed_captioning' => '\OpenAPI\Client\Model\AccountSettingsInMeetingClosedCaptioning',
        'co_host' => 'bool',
        ...
        'language_interpretation' => '\OpenAPI\Client\Model\AccountSettingsInMeetingLanguageInterpretation',
        'live_streaming_facebook' => 'bool',
        'live_streaming_youtube' => 'bool',
        'manual_captioning' => '\OpenAPI\Client\Model\GetGroupSettings200ResponseOneOfInMeetingManualCaptioning',
        ...
        'p2p_ports' => 'bool',
        'polling' => 'bool',
        'meeting_polling' => '\OpenAPI\Client\Model\AccountSettingsInMeetingMeetingPolling',
        'ports_range' => 'string',
        ...
        'virtual_background_settings' => '\OpenAPI\Client\Model\AccountSettingsInMeetingVirtualBackgroundSettings',
        'watermark' => 'bool',
        'webinar_chat' => '\OpenAPI\Client\Model\AccountSettingsInMeetingWebinarChat',
        'webinar_live_streaming' => '\OpenAPI\Client\Model\AccountSettingsInMeetingWebinarLiveStreaming',
        'webinar_polling' => '\OpenAPI\Client\Model\AccountSettingsInMeetingWebinarPolling',
     ...
     *
     * @param bool|null $alert_guest_join Identify guest participants in a meeting or webinar.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $allow_participants_to_rename If the value of this field is set to `true`, meeting participants and webinar panelists can be allowed to rename themselves during a meeting or a webinar.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $allow_show_zoom_windows Show the Zoom desktop application when sharing screens.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $anonymous_question_answer Allow an anonymous Q&A in a webinar.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $auto_saving_chat Automatically save all in-meeting chats so that the host does not need to manually save the chat transcript after the meeting starts.
     *
     * @return self
     */
     ...
     * Sets chat
     *
     * @param bool|null $chat Allow meeting participants to send a message that is visible to all participants.
     *
     * @return self
     */
     ...
     * Sets closed_caption
     *
     * @param bool|null $closed_caption Allow a host to type closed captions. Enable a host to assign a participant or third party device to add closed captions.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AccountSettingsInMeetingClosedCaptioning|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountSettingsInMeetingClosedCaptioning|null $closed_captioning closed_captioning
     *
     * @return self
     */
     ...
     * Sets dscp_audio
     *
     * @param int|null $dscp_audio DSCP audio.
     *
     * @return self
     */
     ...
     * Sets dscp_marking
     *
     * @param bool|null $dscp_marking DSCP marking.
     *
     * @return self
     */
     ...
     * Sets dscp_video
     *
     * @param int|null $dscp_video DSCP video.
     *
     * @return self
     */
     ...
     *
     * @param string|null $entry_exit_chime Play sound when participants join or leave.<br>`host` - Heard by host only.<br>`all` - Heard by host and all attendees.<br>`none` - Disable.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $far_end_camera_control Allow another user to take control of your camera during a meeting.
     *
     * @return self
     */
     ...
     * Sets feedback
     *
     * @param bool|null $feedback Add a \"Feedback\" tab to the Windows Settings or Mac Preferences dialog. Enable users to provide feedback to Zoom at the end of the meeting.
     *
     * @return self
     */
     ...
     * Sets file_transfer
     *
     * @param bool|null $file_transfer Indicates whether [in-meeting file transfer](https://support.zoom.us/hc/en-us/articles/209605493-In-meeting-file-transfer) setting has been enabled on the account or not.
     *
     * @return self
     */
     ...
     * Sets group_hd
     *
     * @param bool|null $group_hd Activate higher quality video for host and participants. Please note: This will use more bandwidth.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AccountSettingsInMeetingLanguageInterpretation|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountSettingsInMeetingLanguageInterpretation|null $language_interpretation language_interpretation
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\GetGroupSettings200ResponseOneOfInMeetingManualCaptioning|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\GetGroupSettings200ResponseOneOfInMeetingManualCaptioning|null $manual_captioning manual_captioning
     *
     * @return self
     */
     ...
     * Sets original_audio
     *
     * @param bool|null $original_audio Allow users to select original sound in their client settings.
     *
     * @return self
     */
     ...
     * Sets p2p_connetion
     *
     * @param bool|null $p2p_connetion Peer to peer connection while only two people are in a meeting.
     *
     * @return self
     */
     ...
     * Sets p2p_ports
     *
     * @param bool|null $p2p_ports Peer to peer listening ports range.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AccountSettingsInMeetingMeetingPolling|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountSettingsInMeetingMeetingPolling|null $meeting_polling meeting_polling
     *
     * @return self
     */
     ...
     * Sets ports_range
     *
     * @param string|null $ports_range The listening ports range, separated by a comma (ex 55,56). The ports range must be between 1 to 65535.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $post_meeting_feedback Display a thumbs up or down survey at the end of each meeting.
     *
     * @return self
     */
     ...
     * Sets private_chat
     *
     * @param bool|null $private_chat Allow a meeting participant to send a private message to another participant.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $record_play_own_voice Record and play their own voice.
     *
     * @return self
     */
     ...
     * Sets remote_control
     *
     * @param bool|null $remote_control Allow users to request remote control.
     *
     * @return self
     */
     ...
     * Sets screen_sharing
     *
     * @param bool|null $screen_sharing Allow screen sharing.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $sending_default_email_invites Only show the default email when sending email invites.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $show_meeting_control_toolbar Always show the meeting control toolbar.
     *
     * @return self
     */
     ...
     * Sets stereo_audio
     *
     * @param bool|null $stereo_audio Allow users to select stereo audio in their client settings.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $use_html_format_email Use HTML formatted email for the Outlook plugin.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $virtual_background Allow users to replace their background with any selected image. Choose or upload an image in the Zoom desktop application settings.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AccountSettingsInMeetingVirtualBackgroundSettings|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountSettingsInMeetingVirtualBackgroundSettings|null $virtual_background_settings virtual_background_settings
     *
     * @return self
     */
     ...
     * Sets watermark
     *
     * @param bool|null $watermark Add a watermark when viewing a shared screen.
     *
     * @return self
     */
     ...
     * Gets webinar_chat
     *
     * @return \OpenAPI\Client\Model\AccountSettingsInMeetingWebinarChat|null
     */
     ...
     * Sets webinar_chat
     *
     * @param \OpenAPI\Client\Model\AccountSettingsInMeetingWebinarChat|null $webinar_chat webinar_chat
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AccountSettingsInMeetingWebinarLiveStreaming|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountSettingsInMeetingWebinarLiveStreaming|null $webinar_live_streaming webinar_live_streaming
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AccountSettingsInMeetingWebinarPolling|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountSettingsInMeetingWebinarPolling|null $webinar_polling webinar_polling
     *
     * @return self
     */
