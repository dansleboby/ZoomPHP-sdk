...
/**
 * AddBatchWebinarRegistrants200ResponseRegistrantsInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class AddBatchWebinarRegistrants200ResponseRegistrantsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addBatchWebinarRegistrants_200_response_registrants_inner';
     ...
     * Sets email
     *
     * @param string|null $email Email address of the registrant.
     *
     * @return self
     */
     ...
     * Sets join_url
     *
     * @param string|null $join_url Unique URL using which registrant can join the webinar.
     *
     * @return self
     */
