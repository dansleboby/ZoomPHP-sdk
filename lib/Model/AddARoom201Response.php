...
/**
 * AddARoom201Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class AddARoom201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addARoom_201_response';
     ...
     * Sets location_id
     *
     * @param string|null $location_id Location ID of the location where the Zoom Room was added.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of the Zoom Room.
     *
     * @return self
     */
