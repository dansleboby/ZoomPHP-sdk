...
/**
 * ListWorkspaces200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class ListWorkspaces200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listWorkspaces_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'workspaces' => '\Zoom\Api\Model\ListWorkspaces200ResponseWorkspacesInner[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ListWorkspaces200Response., must be smaller than or equal to 300.');
        }
     ...
     * Gets workspaces
     *
     * @return \Zoom\Api\Model\ListWorkspaces200ResponseWorkspacesInner[]|null
     */
     ...
     * Sets workspaces
     *
     * @param \Zoom\Api\Model\ListWorkspaces200ResponseWorkspacesInner[]|null $workspaces Information about the workspace.
     *
     * @return self
     */
