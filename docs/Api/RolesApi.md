...
$body = new \Zoom\Api\Model\InlineObject30(); // \Zoom\Api\Model\InlineObject30 | 
 ...
 **body** | [**\Zoom\Api\Model\InlineObject30**](../Model/InlineObject30.md)|  |
...
$body = new \Zoom\Api\Model\InlineObject29(); // \Zoom\Api\Model\InlineObject29 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Zoom\Api\Model\InlineObject29**](../Model/InlineObject29.md)|  | [optional]
...
$role_id = 'role_id_example'; // string | Role Id
$body = new \Zoom\Api\Model\InlineObject53(); // \Zoom\Api\Model\InlineObject53 | 
...
------------- | ------------- | ------------- | -------------
 **role_id** | **string**| Role Id |
 **body** | [**\Zoom\Api\Model\InlineObject53**](../Model/InlineObject53.md)|  | [optional]
