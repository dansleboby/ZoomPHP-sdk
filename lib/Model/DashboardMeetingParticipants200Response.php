...
/**
 * DashboardMeetingParticipants200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class DashboardMeetingParticipants200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dashboardMeetingParticipants_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'participants' => '\Zoom\Api\Model\DashboardMeetingParticipants200ResponseAllOfParticipantsInner[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling DashboardMeetingParticipants200Response., must be smaller than or equal to 300.');
        }
     ...
     * Gets participants
     *
     * @return \Zoom\Api\Model\DashboardMeetingParticipants200ResponseAllOfParticipantsInner[]|null
     */
     ...
     * Sets participants
     *
     * @param \Zoom\Api\Model\DashboardMeetingParticipants200ResponseAllOfParticipantsInner[]|null $participants Information about the meeting participants. If a participant left a meeting and rejoined the same meeting, their information will appear as many times as they joined the meeting.
     *
     * @return self
     */
