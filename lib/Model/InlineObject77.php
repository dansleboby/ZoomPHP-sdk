 ...
 * @link     https://openapi-generator.tech
 */
class InlineObject77 implements ModelInterface, ArrayAccess
{
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number to be blocked if you passed \"phoneNumber\" as the value for the `match_type` field. If you passed \"prefix\" as the value for the `match_type` field, provide the prefix of the phone number here including the country code. For example, entering 1905 blocks numbers with country code 1 and area code 905.
     *
     * @return $this
     */
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling InlineObject77., must be smaller than or equal to 50.');
        }
     ...
     * Sets block_type
     *
     * @param string|null $block_type State whether you want the block type to be inbound or outbound.<br> `inbound`: Pass this value to prevent the blocked number or prefix from calling in to phone users.<br> `outbound`: Pass this value to prevent phone users from calling the blocked number or prefix.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Enable or disable the blocking. One of the following values are allowed:<br> `active`: Keep the blocking active.<br> `inactive`: Disable the blocking.
     *
     * @return $this
     */
     ...
     * Sets comment
     *
     * @param string|null $comment Provide a comment to help you identify the blocked number or prefix.
     *
     * @return $this
     */
    public function setComment($comment)
    {
        if (!is_null($comment) && (mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling InlineObject77., must be smaller than or equal to 255.');
        }
