...
class InlineResponse2006 implements ModelInterface, ArrayAccess
{
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date provided in the query parameter. If a date is not provided, the default value is the **current date**.
     *
     * @return $this
     */
     ...
     * Gets messages
     *
     * @return \Zoom\Api\Model\InlineResponse2006Messages[]|null
     */
     ...
     * Sets messages
     *
     * @param \Zoom\Api\Model\InlineResponse2006Messages[]|null $messages List of message(s).
     *
     * @return $this
     */
