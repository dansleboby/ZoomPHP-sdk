...
class InlineObject75 implements ModelInterface, ArrayAccess
{
     ...
     * Sets site_id
     *
     * @param string|null $site_id Unique identifier of the [site](https://support.zoom.us/hc/en-us/articles/360020809672). This can be retrieved from List Sites API.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description Description for the common area phone.
     *
     * @return $this
     */
    ...
    public function setType($type)
    {
        if ((mb_strlen($type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $type when calling InlineObject75., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling InlineObject75., must be bigger than or equal to 1.');
        }
     ...
     * Sets model
     *
     * @param string|null $model Device Model name. Refer to the \"Model Name\" field in [this](https://marketplace.zoom.us/docs/api-reference/other-references/zoomphone-supporteddevice) table.
     *
     * @return $this
     */
    public function setModel($model)
    {
        if (!is_null($model) && (mb_strlen($model) > 50)) {
            throw new \InvalidArgumentException('invalid length for $model when calling InlineObject75., must be smaller than or equal to 50.');
        }
        if (!is_null($model) && (mb_strlen($model) < 1)) {
            throw new \InvalidArgumentException('invalid length for $model when calling InlineObject75., must be bigger than or equal to 1.');
        }
     ...
     * Sets time_zone
     *
     * @param string|null $time_zone [Timezone ID](https://marketplace.zoom.us/docs/api-reference/other-references/abbreviation-lists) for the common area phone.
     *
     * @return $this
     */
