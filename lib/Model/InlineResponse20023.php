...
class InlineResponse20023 implements ModelInterface, ArrayAccess
{
     ...
     * Sets host_id
     *
     * @param int|null $host_id Host ID.
     *
     * @return $this
     */
     ...
     * Sets start_time
     *
     * @param \DateTime|null $start_time Meeting start time (GMT).
     *
     * @return $this
     */
     ...
     * Sets end_time
     *
     * @param \DateTime|null $end_time Meeting end time (GMT).
     *
     * @return $this
     */
     ...
     * Sets total_minutes
     *
     * @param int|null $total_minutes Sum of meeting minutes from all participants in the meeting.
     *
     * @return $this
     */
