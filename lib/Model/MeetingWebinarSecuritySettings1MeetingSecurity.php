...
/**
 * MeetingWebinarSecuritySettings1MeetingSecurity Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingWebinarSecuritySettings1MeetingSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Meeting_Webinar_Security_Settings_1_meeting_security';
    ...
    public function setBlockUserDomainList($block_user_domain_list)
    {
        ...
        if (!is_null($block_user_domain_list) && (count($block_user_domain_list) > 20)) {
            throw new \InvalidArgumentException('invalid value for $block_user_domain_list when calling MeetingWebinarSecuritySettings1MeetingSecurity., number of items must be less than or equal to 20.');
        }
