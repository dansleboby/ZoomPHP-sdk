...
/**
 * MeetingUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'meetingUpdate_request';
     ...
     * Sets schedule_for
     *
     * @param string|null $schedule_for The email address or `userId` of the user to schedule a meeting for.
     *
     * @return self
     */
    ...
    public function setAgenda($agenda)
    {
        if (!is_null($agenda) && (mb_strlen($agenda) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $agenda when calling MeetingUpdateRequest., must be smaller than or equal to 2000.');
        }
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 10)) {
            throw new \InvalidArgumentException('invalid length for $password when calling MeetingUpdateRequest., must be smaller than or equal to 10.');
        }
