...
class InlineResponse20073RecordingFiles implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_73_recording_files';
     ...
     * Sets id
     *
     * @param string|null $id Recording ID. Identifier for the recording.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $recording_start The date and time at which the recording started.
     *
     * @return $this
     */
     ...
     * Sets recording_end
     *
     * @param string|null $recording_end The date and time at which the recording ended.
     *
     * @return $this
     */
     ...
     * Sets file_size
     *
     * @param float|null $file_size The size of the recording file in bytes.
     *
     * @return $this
     */
     ...
     * Sets play_url
     *
     * @param string|null $play_url The URL using which recording can be played.
     *
     * @return $this
     */
     ...
     * Sets download_url
     *
     * @param string|null $download_url The URL using which the recording can be downloaded
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of the recording.
     *
     * @return $this
     */
     ...
     * Sets meeting_id
     *
     * @param string|null $meeting_id Universally unique identifier of the meeting instance that was being recorded.
     *
     * @return $this
     */
