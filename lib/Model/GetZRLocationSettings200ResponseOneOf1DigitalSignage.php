...
/**
 * GetZRLocationSettings200ResponseOneOf1DigitalSignage Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class GetZRLocationSettings200ResponseOneOf1DigitalSignage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getZRLocationSettings_200_response_oneOf_1_digital_signage';
    ...
    public function setPlayList($play_list)
    {
        ...
        if (!is_null($play_list) && (count($play_list) > 2)) {
            throw new \InvalidArgumentException('invalid value for $play_list when calling GetZRLocationSettings200ResponseOneOf1DigitalSignage., number of items must be less than or equal to 2.');
        }
