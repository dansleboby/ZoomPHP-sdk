...
/**
 * GetZRAccountProfile200ResponseBasic Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class GetZRAccountProfile200ResponseBasic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getZRAccountProfile_200_response_basic';
     ...
     *
     * @param bool|null $required_code_to_ext Require code to exit out of the Zoom Rooms application to switch between other apps.
     *
     * @return self
     */
     ...
     * Sets room_passcode
     *
     * @param string|null $room_passcode 1-16 digit number or characters used to secure your Zoom Rooms application. This code must be entered on your Zoom Room Controller to change settings or to sign out.
     *
     * @return self
     */
    public function setRoomPasscode($room_passcode)
    {
        if (!is_null($room_passcode) && (mb_strlen($room_passcode) > 16)) {
            throw new \InvalidArgumentException('invalid length for $room_passcode when calling GetZRAccountProfile200ResponseBasic., must be smaller than or equal to 16.');
        }
        if (!is_null($room_passcode) && (mb_strlen($room_passcode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $room_passcode when calling GetZRAccountProfile200ResponseBasic., must be bigger than or equal to 1.');
        }
     ...
     * Sets support_email
     *
     * @param string|null $support_email The email address used for reporting Zoom Room issues.
     *
     * @return self
     */
     ...
     * Sets support_phone
     *
     * @param string|null $support_phone The phone number used for reporting Zoom room issues.
     *
     * @return self
     */
