...
/**
 * MeetingWebinarSecurityGroupLockedSettings1MeetingSecurity Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingWebinarSecurityGroupLockedSettings1MeetingSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Meeting_Webinar_Security_Group_Locked_Settings_1_meeting_security';
     ...
     *
     * @param bool|null $approved_or_denied_countries_or_regions Whether to enable the [**Approve or block entry for users from specific countries/regions**](https://support.zoom.us/hc/en-us/articles/360060086231-Joining-from-specific-countries-regions) setting.
     *
     * @return self
     */
