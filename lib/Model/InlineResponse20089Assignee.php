...
class InlineResponse20089Assignee implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_89_assignee';
     ...
     * Sets id
     *
     * @param string|null $id User ID of the user to whom the device has been assigned.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $extension_number Extension number of the Zoom Phone used by the user.
     *
     * @return $this
     */
