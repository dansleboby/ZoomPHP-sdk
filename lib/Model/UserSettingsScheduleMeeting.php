...
class UserSettingsScheduleMeeting implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool|null $embed_password_in_join_link If the value is set to `true`, the meeting passcode will be encrypted and included in the join meeting link to allow participants to join with just one click without having to enter the passcode.
     *
     * @return $this
     */
