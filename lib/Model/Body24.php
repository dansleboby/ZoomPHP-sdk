...
class Body24 implements ModelInterface, ArrayAccess
{
     ...
     * Sets action
     *
     * @param string $action `end` - End a meeting.<br> `recover` - [Recover](https://support.zoom.us/hc/en-us/articles/360038297111-Recover-a-deleted-meeting) a deleted meeting.
     *
     * @return $this
     */
