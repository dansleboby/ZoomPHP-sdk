...
class Registrant implements ModelInterface, ArrayAccess
{
     ...
     * Sets country
     *
     * @param string $country Registrant's country. The value of this field must be in two-letter abbreviated form and must match the ID field provided in the [Countries](https://marketplace.zoom.us/docs/api-reference/other-references/abbreviation-lists#countries) table.
     *
     * @return $this
     */
