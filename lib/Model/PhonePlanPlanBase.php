...
/**
 * PhonePlanPlanBase Class Doc Comment
 *
 * @category Class
 ...
 */
class PhonePlanPlanBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhonePlan_plan_base';
     ...
     * Sets type
     *
     * @param string|null $type The [Zoom Phone Base plan type](https://marketplace.zoom.us/docs/api-reference/other-references/plans#additional-zoom-phone-plans).
     *
     * @return self
     */
