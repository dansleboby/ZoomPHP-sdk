...
/**
 * DashboardMeetings200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class DashboardMeetings200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dashboardMeetings_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'meetings' => '\Zoom\Api\Model\Listmeetingmetrics[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling DashboardMeetings200Response., must be smaller than or equal to 300.');
        }
     ...
     * Gets meetings
     *
     * @return \Zoom\Api\Model\Listmeetingmetrics[]|null
     */
     ...
     * Sets meetings
     *
     * @param \Zoom\Api\Model\Listmeetingmetrics[]|null $meetings Array of meeting objects.
     *
     * @return self
     */
