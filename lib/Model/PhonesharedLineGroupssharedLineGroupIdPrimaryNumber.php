...
class PhonesharedLineGroupssharedLineGroupIdPrimaryNumber implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'phoneshared_line_groupssharedLineGroupId_primary_number';
     ...
     * Sets id
     *
     * @param string $id Phone Number ID. Unique Identifier of the Phone Number.
     *
     * @return $this
     */
     ...
     * Sets number
     *
     * @param string $number Phone Number that you would like to assign as the primary number for this Shared Line Group.
     *
     * @return $this
     */
