...
/**
 * AccountUpdateSettingsInMeetingMeetingPolling Class Doc Comment
 *
 * @category Class
 ...
 */
class AccountUpdateSettingsInMeetingMeetingPolling implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountUpdateSettings_in_meeting_meeting_polling';
     ...
     * Sets enable
     *
     * @param bool|null $enable Whether to allow the host to add polls before or during a meeting.
     *
     * @return self
     */
     ...
     * Sets advanced_polls
     *
     * @param bool|null $advanced_polls Whether to allow the host to create advanced polls and quizzes. Advanced polls and quizzes include single choice, multiple choice, drop down, matching, short answer, long answer, rank order, and fill-in-the-blank questions. Hosts can also set the correct answers for quizzes they create.
     *
     * @return self
     */
