...
/**
 * MeetingOrWebinarSecurityAccountSettings1MeetingSecurity Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingOrWebinarSecurityAccountSettings1MeetingSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Meeting_or_Webinar_Security_Account_Settings_1_meeting_security';
    ...
    protected static $openAPITypes = [
        ...
        'chat_etiquette_tool' => '\Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettings1MeetingSecurityChatEtiquetteTool',
        'embed_password_in_join_link' => 'bool',
        'encryption_type' => 'string',
        'end_to_end_encrypted_meetings' => 'bool',
        'meeting_password' => 'bool',
        'meeting_password_requirement' => '\Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettings1MeetingSecurityMeetingPasswordRequirement',
        ...
        'waiting_room' => 'bool',
        'waiting_room_settings' => '\Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettings1MeetingSecurityWaitingRoomSettings',
    ...
    public function setBlockUserDomainList($block_user_domain_list)
    {
        ...
        if (!is_null($block_user_domain_list) && (count($block_user_domain_list) > 20)) {
            throw new \InvalidArgumentException('invalid value for $block_user_domain_list when calling MeetingOrWebinarSecurityAccountSettings1MeetingSecurity., number of items must be less than or equal to 20.');
        }
     ...
     *
     * @return \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettings1MeetingSecurityChatEtiquetteTool|null
     */
     ...
     *
     * @param \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettings1MeetingSecurityChatEtiquetteTool|null $chat_etiquette_tool chat_etiquette_tool
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettings1MeetingSecurityMeetingPasswordRequirement|null
     */
     ...
     *
     * @param \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettings1MeetingSecurityMeetingPasswordRequirement|null $meeting_password_requirement meeting_password_requirement
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettings1MeetingSecurityWaitingRoomSettings|null
     */
     ...
     *
     * @param \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettings1MeetingSecurityWaitingRoomSettings|null $waiting_room_settings waiting_room_settings
     *
     * @return self
     */
