...
/**
 * GetHotDeskUsage200ResponseDeskUsage Class Doc Comment
 *
 * @category Class
 * @description Information about the workspace desk usage.
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetHotDeskUsage200ResponseDeskUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getHotDeskUsage_200_response_desk_usage';
     ...
     * Sets in_use
     *
     * @param int|null $in_use The number of desks in use.
     *
     * @return self
     */
     ...
     * Sets not_in_use
     *
     * @param int|null $not_in_use The number of desks not in use.
     *
     * @return self
     */
