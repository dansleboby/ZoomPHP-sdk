...
/**
 * ReportMeetingParticipants200ResponseAllOfParticipantsInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class ReportMeetingParticipants200ResponseAllOfParticipantsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reportMeetingParticipants_200_response_allOf_participants_inner';
    ...
    public function setCustomerKey($customer_key)
    {
        if (!is_null($customer_key) && (mb_strlen($customer_key) > 15)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling ReportMeetingParticipants200ResponseAllOfParticipantsInner., must be smaller than or equal to 15.');
        }
     ...
     * Sets failover
     *
     * @param bool|null $failover Indicates if failover happened during the meeting.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Participant display name.  This returns an empty string value if the account calling the API is a BAA account.
     *
     * @return self
     */
     ...
     * Sets registrant_id
     *
     * @param string|null $registrant_id Unique identifier of the registrant. This field is only returned if you entered \"registrant_id\" as the value of `include_fields` query parameter.
     *
     * @return self
     */
     ...
     * Sets user_email
     *
     * @param string|null $user_email Participant email.  If the participant is **not** part of the host's account, this returns an empty string value, with some exceptions. See [Email address display rules](https://marketplace.zoom.us/docs/api-reference/using-zoom-apis#email-address) for details. This returns an empty string value if the account calling the API is a BAA account.
     *
     * @return self
     */
