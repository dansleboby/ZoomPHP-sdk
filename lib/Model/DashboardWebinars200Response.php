...
/**
 * DashboardWebinars200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class DashboardWebinars200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dashboardWebinars_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'webinars' => '\Zoom\Api\Model\WebinarMetric[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling DashboardWebinars200Response., must be smaller than or equal to 300.');
        }
     ...
     * Gets webinars
     *
     * @return \Zoom\Api\Model\WebinarMetric[]|null
     */
     ...
     * Sets webinars
     *
     * @param \Zoom\Api\Model\WebinarMetric[]|null $webinars Array of webinar objects.
     *
     * @return self
     */
