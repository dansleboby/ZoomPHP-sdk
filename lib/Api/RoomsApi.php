...
class RoomsApi
{
     ...
     * Add a Zoom Room
     *
     * @param  \Zoom\Api\Model\InlineObject2 $body body (optional)
     *
     ...
     * Add a Zoom Room
     *
     * @param  \Zoom\Api\Model\InlineObject2 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function addARoomWithHttpInfo($body = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Zoom\Api\Model\InlineResponse201' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse201', []),
     ...
     * @param  \Zoom\Api\Model\InlineObject65 $body body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     *
     * @param  string $room_id Unique Identifier of the Zoom Room. (required)
     * @param  \Zoom\Api\Model\InlineObject65 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation checkInRooms
     *
     * Check-in or Check-out of a Zoom Room
     *
     * @param  string $id Room ID (required)
     * @param  \Zoom\Api\Model\InlineObject83 $body body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function checkInRooms($id, $body = null)
    {
        list($response) = $this->checkInRoomsWithHttpInfo($id, $body);
        return $response;
    }

    /**
     * Operation checkInRoomsWithHttpInfo
     *
     * Check-in or Check-out of a Zoom Room
     *
     * @param  string $id Room ID (required)
     * @param  \Zoom\Api\Model\InlineObject83 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function checkInRoomsWithHttpInfo($id, $body = null)
    {
        $request = $this->checkInRoomsRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkInRoomsAsync($id, $body = null)
    {
        return $this->checkInRoomsAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation checkInRoomsAsyncWithHttpInfo
     *
     * Check-in or Check-out of a Zoom Room
     *
     * @param  string $id Room ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkInRoomsAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = 'object';
        $request = $this->checkInRoomsRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function checkInRoomsRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling checkInRooms'
            );
        }

        $resourcePath = '/v2/rooms/{id}/events';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getZRProfileWithHttpInfo($room_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20080' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20080', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  string $type Specify the type of digital signane resource. The value can be one of the following: * &#x60;content&#x60;: Returns information about content files. * &#x60;folder&#x60;: Returns information about the folder where the content files are located. (optional)
    ...
    public function listDigitalSignageContentWithHttpInfo($type = null, $folder_id = null, $page_size = 30, $next_page_token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse200104' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse200104', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listDigitalSignageContentRequest($type = null, $folder_id = null, $page_size = 30, $next_page_token = null)
    {
        if ($page_size !== null && $page_size > 300) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling RoomsApi.listDigitalSignageContent, must be smaller than or equal to 300.');
        }
    ...
    public function listZRDevicesWithHttpInfo($room_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20081' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20081', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function listZoomRoomsWithHttpInfo($status = null, $type = null, $unassigned_rooms = false, $page_size = 30, $next_page_token = null, $location_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse2002' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse2002', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    protected function listZoomRoomsRequest($status = null, $type = null, $unassigned_rooms = false, $page_size = 30, $next_page_token = null, $location_id = null)
    {
        ...
        // query params
        if (is_array($unassigned_rooms)) {
            $unassigned_rooms = ObjectSerializer::serializeCollection($unassigned_rooms, '', true);
        }
        if ($unassigned_rooms !== null) {
            $queryParams['unassigned_rooms'] = $unassigned_rooms;
        }
        // query params
        if (is_array($page_size)) {
            $page_size = ObjectSerializer::serializeCollection($page_size, '', true);
     ...
     *
     * @param  string $room_id Unique Identifier of a Zoom Room. (required)
     * @param  \Zoom\Api\Model\InlineObject60 $body body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     *
     * @param  string $room_id Unique Identifier of a Zoom Room. (required)
     * @param  \Zoom\Api\Model\InlineObject60 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return object
     */
    public function updateZRSettings($room_id, $setting_type = null, $body = null)
    {
        list($response) = $this->updateZRSettingsWithHttpInfo($room_id, $setting_type, $body);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateZRSettingsWithHttpInfo($room_id, $setting_type = null, $body = null)
    {
        $request = $this->updateZRSettingsRequest($room_id, $setting_type, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateZRSettingsAsync($room_id, $setting_type = null, $body = null)
    {
        return $this->updateZRSettingsAsyncWithHttpInfo($room_id, $setting_type, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateZRSettingsAsyncWithHttpInfo($room_id, $setting_type = null, $body = null)
    {
        $returnType = 'object';
        $request = $this->updateZRSettingsRequest($room_id, $setting_type, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateZRSettingsRequest($room_id, $setting_type = null, $body = null)
    {
        // verify the required parameter 'room_id' is set
        if ($room_id === null || (is_array($room_id) && count($room_id) === 0)) {
            throw new \InvalidArgumentException(
