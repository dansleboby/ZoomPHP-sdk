...
/**
 * PhoneSharedLineGroupsSharedLineGroupIdPrimaryNumber Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PhoneSharedLineGroupsSharedLineGroupIdPrimaryNumber implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_phone_shared_line_groups__sharedLineGroupId__primary_number';
     ...
     * Sets id
     *
     * @param string|null $id Phone Number ID. Unique Identifier of the Phone Number.
     *
     * @return $this
     */
     ...
     * Sets number
     *
     * @param string|null $number Phone Number that you would like to assign as the primary number for this Shared Line Group.
     *
     * @return $this
     */
