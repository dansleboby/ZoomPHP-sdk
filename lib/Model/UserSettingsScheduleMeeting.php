 ...
 */
class UserSettingsScheduleMeeting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserSettingsScheduleMeeting';
    ...
    protected static $openAPITypes = [
        ...
        'meeting_password_requirement' => '\OpenAPI\Client\Model\UserSettingsScheduleMeetingMeetingPasswordRequirement',
     ...
     *
     * @param bool|null $embed_password_in_join_link Encrypt the meeting passcode and include it in the join meeting link to allow participants to join with just one click without having to enter the passcode.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\UserSettingsScheduleMeetingMeetingPasswordRequirement|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\UserSettingsScheduleMeetingMeetingPasswordRequirement|null $meeting_password_requirement meeting_password_requirement
     *
     * @return self
     */
     ...
     *
     * @param bool|null $require_password_for_instant_meetings Require a passcode for instant meetings. If you use PMI for your instant meetings, this option will be disabled. This setting is always enabled for free accounts and Pro accounts with a single host and cannot be modified for these accounts.
     *
     * @return self
     */
