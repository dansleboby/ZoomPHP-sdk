...
class InlineResponse20097BlockedList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_97_blocked_list';
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier of the blocked list.
     *
     * @return $this
     */
     ...
     * Sets block_type
     *
     * @param string|null $block_type Block type.<br> `inbound`: The blocked number or numbers with the specifie prefix are prevented from calling in to phone users.<br><br> `outbound`: The phone users  are prevented from calling the blocked number or numbers with the specified prefix.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Indicates whether the blocking is active or inactive. <br> `active`: The blocked list is active.<br> `inactive`: The blocked list is inactive.
     *
     * @return $this
     */
