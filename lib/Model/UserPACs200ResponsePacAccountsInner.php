...
/**
 * UserPACs200ResponsePacAccountsInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class UserPACs200ResponsePacAccountsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userPACs_200_response_pac_accounts_inner';
    ...
    protected static $openAPITypes = [
        'conference_id' => 'int',
        'dedicated_dial_in_number' => '\Zoom\Api\Model\UserPACs200ResponsePacAccountsInnerDedicatedDialInNumberInner[]',
        'global_dial_in_numbers' => '\Zoom\Api\Model\UserPACs200ResponsePacAccountsInnerGlobalDialInNumbersInner[]',
     ...
     * Sets conference_id
     *
     * @param int|null $conference_id The conference ID.
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\UserPACs200ResponsePacAccountsInnerDedicatedDialInNumberInner[]|null
     */
     ...
     *
     * @param \Zoom\Api\Model\UserPACs200ResponsePacAccountsInnerDedicatedDialInNumberInner[]|null $dedicated_dial_in_number Information about the account's dedicated dial-in numbers.
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\UserPACs200ResponsePacAccountsInnerGlobalDialInNumbersInner[]|null
     */
     ...
     *
     * @param \Zoom\Api\Model\UserPACs200ResponsePacAccountsInnerGlobalDialInNumbersInner[]|null $global_dial_in_numbers Information about the account's global dial-in numbers.
     *
     * @return self
     */
     ...
     *
     * @param string|null $listen_only_password The listen-only password, up to six characters in length.
     *
     * @return self
     */
    public function setListenOnlyPassword($listen_only_password)
    {
        if (!is_null($listen_only_password) && (mb_strlen($listen_only_password) > 6)) {
            throw new \InvalidArgumentException('invalid length for $listen_only_password when calling UserPACs200ResponsePacAccountsInner., must be smaller than or equal to 6.');
        }
     ...
     *
     * @param string|null $participant_password The participant password, up to six characters in length.
     *
     * @return self
     */
    public function setParticipantPassword($participant_password)
    {
        if (!is_null($participant_password) && (mb_strlen($participant_password) > 6)) {
            throw new \InvalidArgumentException('invalid length for $participant_password when calling UserPACs200ResponsePacAccountsInner., must be smaller than or equal to 6.');
        }
