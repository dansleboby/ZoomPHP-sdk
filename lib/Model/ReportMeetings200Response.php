...
/**
 * ReportMeetings200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class ReportMeetings200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reportMeetings_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'total_records' => 'int',
        'from' => '\DateTime',
        'meetings' => '\Zoom\Api\Model\ReportMeetings200ResponseAllOfMeetingsInner[]',
        'to' => '\DateTime'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ReportMeetings200Response., must be smaller than or equal to 300.');
        }
     ...
     * Gets meetings
     *
     * @return \Zoom\Api\Model\ReportMeetings200ResponseAllOfMeetingsInner[]|null
     */
     ...
     * Sets meetings
     *
     * @param \Zoom\Api\Model\ReportMeetings200ResponseAllOfMeetingsInner[]|null $meetings Information about the meeting.
     *
     * @return self
     */
