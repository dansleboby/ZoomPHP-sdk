...
/**
 * UserInMeetingSettings Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class UserInMeetingSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_In_Meeting_Settings';
    ...
    protected static $openAPITypes = [
        ...
        'chat' => 'bool',
        'closed_caption' => 'bool',
        'closed_captioning' => '\Zoom\Api\Model\UserInMeetingSettingsClosedCaptioning',
        'co_host' => 'bool',
        ...
        'language_interpretation' => '\Zoom\Api\Model\UserInMeetingSettingsLanguageInterpretation',
        ...
        'virtual_background_settings' => '\Zoom\Api\Model\UserInMeetingSettingsVirtualBackgroundSettings',
        'waiting_room' => 'bool',
        'webinar_chat' => '\Zoom\Api\Model\UserInMeetingSettingsWebinarChat',
        'webinar_live_streaming' => '\Zoom\Api\Model\UserInMeetingSettingsWebinarLiveStreaming',
        'webinar_polling' => '\Zoom\Api\Model\UserInMeetingSettingsWebinarPolling',
        'webinar_survey' => 'bool',
     ...
     *
     * @param bool|null $allow_live_streaming Allow livestreaming.
     *
     * @return self
     */
     ...
     *
     * @param int|null $allow_users_save_chats How participants can save meeting chats:  * `1` — Participants cannot save meeting chats.  * `2` — Participants can only save host and co-host meeting chats.  * `3` — Participants can save all meeting chats.
     *
     * @return self
     */
     ...
     * Sets annotation
     *
     * @param bool|null $annotation Allow meeting participants to use the [annotation tools](https://support.zoom.us/hc/en-us/articles/115005706806). This value defaults to `false`.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $attendee_on_hold Allow the host to put an attendee on hold. This value defaults to `false`. **This field has been deprecated and is no longer supported.**
     *
     * @return self
     */
     ...
     *
     * @param bool|null $auto_saving_chat Automatically save all in-meeting chats. This value defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets breakout_room
     *
     * @param bool|null $breakout_room Allow the meeting host to split meeting participants into separate breakout rooms.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $breakout_room_schedule Allow the host to assign participants to breakout rooms when scheduling. This feature is **only** available in version 4.5.0 or higher.
     *
     * @return self
     */
     ...
     * Sets chat
     *
     * @param bool|null $chat Enable chat during meeting for all participants. This value defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets closed_caption
     *
     * @param bool|null $closed_caption Enable closed captions. This value defaults to `false`.
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\UserInMeetingSettingsClosedCaptioning|null
     */
     ...
     *
     * @param \Zoom\Api\Model\UserInMeetingSettingsClosedCaptioning|null $closed_captioning closed_captioning
     *
     * @return self
     */
     ...
     * Sets co_host
     *
     * @param bool|null $co_host Allow the host to add co-hosts. This value defaults to `false`.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $custom_live_streaming_service Allow custom livestreaming.
     *
     * @return self
     */
     ...
     *
     * @param string|null $custom_service_instructions The custom livestreaming service instructions.
     *
     * @return self
     */
     ...
     * Sets e2e_encryption
     *
     * @param bool|null $e2e_encryption Require [AES encryption](https://en.wikipedia.org/wiki/Advanced_Encryption_Standard) for meetings.
     *
     * @return self
     */
     ...
     *
     * @param string|null $entry_exit_chime When to play the meeting entry/exit sound notification:  * `host` — Only when the host joins or leaves.  * `all` — When any participant joins or leaves.  * `none` - Disable the entry/exit sound notification.   This value defaults to `all`.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $far_end_camera_control Allow another user to take control of the user's camera. This value defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets feedback
     *
     * @param bool|null $feedback Enable the [**Feedback to Zoom**](https://support.zoom.us/hc/en-us/articles/115005838023-Feedback-to-Zoom) setting. This value defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets group_hd
     *
     * @param bool|null $group_hd Enable group HD video. This value defaults to `false`.
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\UserInMeetingSettingsLanguageInterpretation|null
     */
     ...
     *
     * @param \Zoom\Api\Model\UserInMeetingSettingsLanguageInterpretation|null $language_interpretation language_interpretation
     *
     * @return self
     */
     ...
     *
     * @param bool|null $live_streaming_facebook Allow Facebook livestreaming.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $live_streaming_youtube Allow YouTube livestreaming.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $non_verbal_feedback Enable the [**Non-verbal feedback**](https://support.zoom.us/hc/en-us/articles/115001286183-Nonverbal-feedback-and-meeting-reactions-) setting.  This value defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets polling
     *
     * @param bool|null $polling Add polls to the meeting controls. This value defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets private_chat
     *
     * @param bool|null $private_chat [Enable private chat](https://support.zoom.us/hc/en-us/articles/360060835932-Enabling-and-disabling-private-chat) between participants during meetings. This value defaults to `false`.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $record_play_voice Let the user record and play their own voice.
     *
     * @return self
     */
     ...
     * Sets remote_control
     *
     * @param bool|null $remote_control Enable the [**Remote control**](https://support.zoom.us/hc/en-us/articles/201362673-Requesting-or-giving-remote-control) setting.  This value defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets remote_support
     *
     * @param bool|null $remote_support Enable the [**Remote support**](https://support.zoom.us/hc/en-us/articles/360060951012-Enabling-remote-support) setting. This value defaults to `false`.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $share_dual_camera Allow the use of shared dual cameras. This value defaults to `false`. **This field is deprecated.**
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param bool|null $show_meeting_control_toolbar Always display the [in-meeting controls](https://support.zoom.us/hc/en-us/articles/360021921032-Zoom-Room-meeting-controls-and-settings#h_01EQCC03TCPRC72VKXZ7W47FDX).
     *
     * @return self
     */
     ...
     *
     * @param bool|null $virtual_background Enable Virtual Backgrounds. This value defaults to `false`.
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\UserInMeetingSettingsVirtualBackgroundSettings|null
     */
     ...
     *
     * @param \Zoom\Api\Model\UserInMeetingSettingsVirtualBackgroundSettings|null $virtual_background_settings virtual_background_settings
     *
     * @return self
     */
     ...
     * Sets waiting_room
     *
     * @param bool|null $waiting_room Enable the [**Waiting Room**](https://support.zoom.us/hc/en-us/articles/115000332726-Waiting-Room) feature. This value defaults to `false`.
     *
     * @return self
     */
     ...
     * Gets webinar_chat
     *
     * @return \Zoom\Api\Model\UserInMeetingSettingsWebinarChat|null
     */
     ...
     * Sets webinar_chat
     *
     * @param \Zoom\Api\Model\UserInMeetingSettingsWebinarChat|null $webinar_chat webinar_chat
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\UserInMeetingSettingsWebinarLiveStreaming|null
     */
     ...
     *
     * @param \Zoom\Api\Model\UserInMeetingSettingsWebinarLiveStreaming|null $webinar_live_streaming webinar_live_streaming
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\UserInMeetingSettingsWebinarPolling|null
     */
     ...
     *
     * @param \Zoom\Api\Model\UserInMeetingSettingsWebinarPolling|null $webinar_polling webinar_polling
     *
     * @return self
     */
     ...
     *
     * @param bool|null $workplace_by_facebook Allow Workplace by Facebook livestreaming.
     *
     * @return self
     */
     ...
     * Sets auto_answer
     *
     * @param bool|null $auto_answer Allow the user to view and add contacts to the [**Auto-answer group in chat**](https://support.zoom.us/hc/en-us/articles/203736135-Auto-answering-invitations-to-meetings) feature. Calls from members of the **Auto Answer Group** will be automatically answered the user.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $allow_show_zoom_windows Enable the [**Show Zoom windows during screen share**](https://support.zoom.us/hc/en-us/articles/360061383571-Showing-Zoom-windows-during-screen-share) feature.
     *
     * @return self
     */
