...
/**
 * MeetingInviteLinksCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingInviteLinksCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'meetingInviteLinksCreate_request';
    ...
    public function setTtl($ttl)
    {
        ...
        if (!is_null($ttl) && ($ttl > 7776000)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling MeetingInviteLinksCreateRequest., must be smaller than or equal to 7776000.');
        }
        if (!is_null($ttl) && ($ttl < 0)) {
            throw new \InvalidArgumentException('invalid value for $ttl when calling MeetingInviteLinksCreateRequest., must be bigger than or equal to 0.');
        }
