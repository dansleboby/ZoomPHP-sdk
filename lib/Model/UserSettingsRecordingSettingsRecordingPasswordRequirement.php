...
class UserSettingsRecordingSettingsRecordingPasswordRequirement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_settings__Recording_settings_recording_password_requirement';
     ...
     * Sets have_letter
     *
     * @param bool|null $have_letter Indicates whether or not passcode must contain at least one alphabetical letter (a, b, c..).
     *
     * @return $this
     */
     ...
     * Sets have_number
     *
     * @param bool|null $have_number Indicates whether or not passcode must contain at least one number(1, 2, 3..).
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $have_special_character Indicates whether or not passcode must contain at least one special character(!, @, #..).
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $only_allow_numeric Indicates whether or not passcode must contain only numeric characters.
     *
     * @return $this
     */
