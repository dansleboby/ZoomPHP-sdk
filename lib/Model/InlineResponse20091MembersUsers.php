...
class InlineResponse20091MembersUsers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_91_members_users';
     ...
     * Sets id
     *
     * @param string|null $id User ID: Unique Identifier of the user.
     *
     * @return $this
     */
