...
/**
 * SessionUpdateSettings Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class SessionUpdateSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SessionUpdate_settings';
    ...
    protected static $openAPITypes = [
        ...
        'meeting_invitees' => '\Zoom\Api\Model\SessionUpdateSettingsAllOfMeetingInviteesInner[]'
    ];
    ...
    public function setCustomKeys($custom_keys)
    {
        ...
        if (!is_null($custom_keys) && (count($custom_keys) > 10)) {
            throw new \InvalidArgumentException('invalid value for $custom_keys when calling SessionUpdateSettings., number of items must be less than or equal to 10.');
        }
     ...
     *
     * @return \Zoom\Api\Model\SessionUpdateSettingsAllOfMeetingInviteesInner[]|null
     */
     ...
     *
     * @param \Zoom\Api\Model\SessionUpdateSettingsAllOfMeetingInviteesInner[]|null $meeting_invitees A list of the meeting's invitees.
     *
     * @return self
     */
