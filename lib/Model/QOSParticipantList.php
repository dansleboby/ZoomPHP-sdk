 ...
 */
class QOSParticipantList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QOSParticipantList';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['page_size'] = $data['page_size'] ?? 1;
     ...
     *
     * @param string|null $next_page_token The next page token is used to paginate through large result sets. A next page token will be returned whenever the set of available results exceed the current page size. The expiration period for this token is 15 minutes.
     *
     * @return self
     */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 10)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling QOSParticipantList., must be smaller than or equal to 10.');
        }
