...
class InlineObject76 implements ModelInterface, ArrayAccess
{
     ...
     * Sets site_id
     *
     * @param string|null $site_id Unique identifier of the [site](https://support.zoom.us/hc/en-us/articles/360020809672-Managing-Multiple-Sites) to which the common area desk phone is assigned.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $extension_number Extension number of the phone. If site code is enabled, provide short extension number instead.
     *
     * @return $this
     */
     ...
     * Sets mac_address
     *
     * @param string|null $mac_address Mac address or serial number of the device. Examples of supported format: \"64-16-7f-37-90-92\" or \"64167f379092\".
     *
     * @return $this
     */
