...
/**
 * UpdateAGroupMemberRequest Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAGroupMemberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateAGroupMember_request';
     ...
     * Sets action
     *
     * @param string $action The action to perform:  * `move` — Remove the group member from one group and move them to a different group.  * `set_primary` — Set the user's primary group.
     *
     * @return self
     */
