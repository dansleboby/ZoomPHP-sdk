...
/**
 * MeetingWebinarSecuritySettingsMeetingSecurity Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingWebinarSecuritySettingsMeetingSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Meeting_Webinar_Security_Settings_meeting_security';
    ...
    protected static $openAPITypes = [
        ...
        'meeting_password_requirement' => '\Zoom\Api\Model\MeetingWebinarSecuritySettingsMeetingSecurityMeetingPasswordRequirement',
    ...
    public function setBlockUserDomainList($block_user_domain_list)
    {
        ...
        if (!is_null($block_user_domain_list) && (count($block_user_domain_list) > 20)) {
            throw new \InvalidArgumentException('invalid value for $block_user_domain_list when calling MeetingWebinarSecuritySettingsMeetingSecurity., number of items must be less than or equal to 20.');
        }
     ...
     *
     * @return \Zoom\Api\Model\MeetingWebinarSecuritySettingsMeetingSecurityMeetingPasswordRequirement|null
     */
     ...
     *
     * @param \Zoom\Api\Model\MeetingWebinarSecuritySettingsMeetingSecurityMeetingPasswordRequirement|null $meeting_password_requirement meeting_password_requirement
     *
     * @return self
     */
