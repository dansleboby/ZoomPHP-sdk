 ...
 */
class UserSettingsMeetingSettingsMeetingPasswordRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets length
     *
     * @param int|null $length The minimum length that the meeting or webinar passcode must have.
     *
     * @return self
     */
