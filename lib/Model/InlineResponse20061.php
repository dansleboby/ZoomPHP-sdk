...
class InlineResponse20061 implements ModelInterface, ArrayAccess
{
     ...
     * Sets id
     *
     * @param string|null $id Zoom User Id.
     *
     * @return $this
     */
     ...
     * Sets phone_user_id
     *
     * @param string|null $phone_user_id Zoom Phone User Id.
     *
     * @return $this
     */
     ...
     * Gets calling_plan
     *
     * @return \Zoom\Api\Model\InlineResponse20061CallingPlan[]|null
     */
     ...
     * Sets calling_plan
     *
     * @param \Zoom\Api\Model\InlineResponse20061CallingPlan[]|null $calling_plan Calling Plan of the user
     *
     * @return $this
     */
     ...
     * Gets phone_numbers
     *
     * @return \Zoom\Api\Model\InlineResponse20061PhoneNumbers[]|null
     */
     ...
     * Sets phone_numbers
     *
     * @param \Zoom\Api\Model\InlineResponse20061PhoneNumbers[]|null $phone_numbers phone_numbers
     *
     * @return $this
     */
     ...
     *
     * @param int|null $extension_number Extension number
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of the user.<br> `activate`: An active user. <br> `deactivate`: User has been deactivated from the ZoomPhone system.
     *
     * @return $this
     */
     ...
     * Sets site_id
     *
     * @param string|null $site_id Unique Identifier for a [site](https://support.zoom.us/hc/en-us/articles/360020809672).
     *
     * @return $this
     */
     ...
     * Sets site_admin
     *
     * @param bool|null $site_admin Indicates whether the user is a [site admin](https://support.zoom.us/hc/en-us/articles/360042099012) or not.
     *
     * @return $this
     */
