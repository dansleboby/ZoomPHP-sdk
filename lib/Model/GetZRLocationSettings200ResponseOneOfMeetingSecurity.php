...
/**
 * GetZRLocationSettings200ResponseOneOfMeetingSecurity Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class GetZRLocationSettings200ResponseOneOfMeetingSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getZRLocationSettings_200_response_oneOf_meeting_security';
     ...
     *
     * @param bool|null $end_to_end_encrypted_meetings Allows use of end-to-end encryption for meetings. If set to `true`, the encryption type is specified in `encryption_type` field.
     *
     * @return self
     */
