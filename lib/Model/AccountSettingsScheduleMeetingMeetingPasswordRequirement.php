...
class AccountSettingsScheduleMeetingMeetingPasswordRequirement implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool $have_upper_and_lower_characters If set to `true`, the password must include both uppercase and lowercase characters.
     *
     * @return $this
     */
     ...
     *
     * @param bool $weak_enhance_detection If set to `true`, users will be informed if the provided password is weak.
     *
     * @return $this
     */
