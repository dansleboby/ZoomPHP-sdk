...
class AccountsAccountIdLockSettingsInMeeting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_accounts__accountId__lock_settings_in_meeting';
     ...
     *
     * @param bool|null $webinar_question_answer 
     *
     * @return $this
     */
     ...
     * Sets dscp_marking
     *
     * @param bool|null $dscp_marking Allow users to select stereo audio during a meeting.
     *
     * @return $this
     */
