...
**members** | [**\Zoom\Api\Model\ChatUsersUserIdChannelsMembers[]**](ChatUsersUserIdChannelsMembers.md) | Member(s) to include in the channel. A max of 5 members can be added to the channel at once with this API. | [optional] 
