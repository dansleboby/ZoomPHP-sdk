...
/**
 * UserSettingsInMeetingManualCaptioning Class Doc Comment
 *
 * @category Class
 ...
 */
class UserSettingsInMeetingManualCaptioning implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserSettingsInMeeting_manual_captioning';
     ...
     * Sets allow_to_type
     *
     * @param bool|null $allow_to_type Allow the host to manually caption or let the host assign a participant to provide manual captioning.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $auto_generated_captions Enable Zoom's [live transcription feature](https://support.zoom.us/hc/en-us/articles/207279736-Managing-closed-captioning-and-live-transcription#h_01FHGGHYJ4457H4GSZY0KM3NSB).
     *
     * @return self
     */
     ...
     *
     * @param bool|null $full_transcript Enable the viewing of full transcripts in the in-meeting side panel.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $manual_captions [Enable manual closed captioning](https://support.zoom.us/hc/en-us/articles/207279736-Managing-closed-captioning-and-live-transcription).
     *
     * @return self
     */
     ...
     * Sets save_captions
     *
     * @param bool|null $save_captions Allow participants to [save closed captions or transcripts](https://support.zoom.us/hc/en-us/articles/360060958752).    **Note:** If the `full_transcript` field is set to `false`, participants **cannot** save captions.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $third_party_captioning_service Allow the use of an API token to integrate with a [3rd-party device](https://support.zoom.us/hc/en-us/articles/115002212983) to provide closed captioning.
     *
     * @return self
     */
