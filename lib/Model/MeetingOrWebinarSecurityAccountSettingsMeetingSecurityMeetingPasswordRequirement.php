...
/**
 * MeetingOrWebinarSecurityAccountSettingsMeetingSecurityMeetingPasswordRequirement Class Doc Comment
 *
 * @category Class
 ...
 */
class MeetingOrWebinarSecurityAccountSettingsMeetingSecurityMeetingPasswordRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Meeting_or_Webinar_Security_Account_Settings_meeting_security_meeting_password_requirement';
     ...
     *
     * @param int|null $consecutive_characters_length The maximum length of consecutive characters (for example, `abcdef`) allowed in a password:  * `4` through `8` — The maximum consecutive characters length. The length is `n` minus `1`, where `n` is the value. For example, if the value is `4`, there can only be a maximum of `3` consecutive characters in a password (for example, `abc1x@8fdh`).  * `0` — No consecutive character restriction.
     *
     * @return self
     */
     ...
     * Sets have_letter
     *
     * @param bool|null $have_letter Whether passwords must contain at least one letter character.
     *
     * @return self
     */
     ...
     * Sets have_number
     *
     * @param bool|null $have_number Whether passwords must contain at least one numeric character.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $have_special_character Whether passwords must contain at least one special character. For example, `!`, `@`, and/or `#` characters.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $have_upper_and_lower_characters Whether passwords must include uppercase and lowercase characters.
     *
     * @return self
     */
     ...
     * Sets length
     *
     * @param int|null $length The minimum password length.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $only_allow_numeric Whether passwords must contain **only** numeric characters.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $weak_enhance_detection Whether users are informed when the provided password is weak.
     *
     * @return self
     */
