...
class InlineObject61 implements ModelInterface, ArrayAccess
{
     ...
     * Sets enable
     *
     * @param bool|null $enable Enable or delete the configuration.<br> The values can be one of the following:<br> `true`: Enable configuration.<br> `false`: Delete configuration
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $show_callout_internal_number If the value of this option is set to `true`, the call-out numbers provided by the Zoom carrier partners will be displayed in the account's list of available call-out numbers in the Zoom Web Portal and Zoom Client.
     *
     * @return $this
     */
