...
/**
 * Users200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class Users200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'users_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'users' => '\Zoom\Api\Model\Users200ResponseUsersInner[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling Users200Response., must be smaller than or equal to 300.');
        }
     ...
     * Gets users
     *
     * @return \Zoom\Api\Model\Users200ResponseUsersInner[]|null
     */
     ...
     * Sets users
     *
     * @param \Zoom\Api\Model\Users200ResponseUsersInner[]|null $users Information about the users.
     *
     * @return self
     */
