...
class InlineResponse20098 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_98';
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number or the prefix number that is blocked based on the `match_type`.
     *
     * @return $this
     */
