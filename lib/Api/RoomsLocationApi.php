...
class RoomsLocationApi
{
     ...
     * Add a Location
     *
     * @param  \Zoom\Api\Model\InlineObject57 $body body (optional)
     *
     ...
     * Add a Location
     *
     * @param  \Zoom\Api\Model\InlineObject57 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function addAZRLocationWithHttpInfo($body = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20077' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20077', []),
     ...
     * @param  \Zoom\Api\Model\InlineObject66 $body body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     * @param  \Zoom\Api\Model\InlineObject66 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function getZRLocationProfileWithHttpInfo($location_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20078' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20078', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function getZRLocationStructureWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20079' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20079', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function listZRLocationsWithHttpInfo($parent_location_id = null, $type = null, $page_size = 30, $next_page_token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20076' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20076', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    protected function listZRLocationsRequest($parent_location_id = null, $type = null, $page_size = 30, $next_page_token = null)
    {
        ...
        if (is_array($parent_location_id)) {
            $parent_location_id = ObjectSerializer::serializeCollection($parent_location_id, '', true);
        }
        if ($parent_location_id !== null) {
            $queryParams['parent_location_id'] = $parent_location_id;
        }
        // query params
        if (is_array($type)) {
     ...
     * @param  \Zoom\Api\Model\InlineObject58 $body body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     *
     * @param  string $location_id Unique Identifier of the location. This can be retrieved from the [List Zoom Room Locations](https://marketplace.zoom.us/docs/api-reference/zoom-api/rooms-location/listzrlocations) API. (required)
     * @param  \Zoom\Api\Model\InlineObject58 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \Zoom\Api\Model\InlineObject59 $body body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     * Update Zoom Rooms Location Structure
     *
     * @param  \Zoom\Api\Model\InlineObject59 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
