...
class Body33 implements ModelInterface, ArrayAccess
{
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling Body33., must be smaller than or equal to 64.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling Body33., must be smaller than or equal to 64.');
        }
    ...
    public function setHostKey($host_key)
    {
        if (!is_null($host_key) && (mb_strlen($host_key) > 10)) {
            throw new \InvalidArgumentException('invalid length for $host_key when calling Body33., must be smaller than or equal to 10.');
        }
        if (!is_null($host_key) && (mb_strlen($host_key) < 6)) {
            throw new \InvalidArgumentException('invalid length for $host_key when calling Body33., must be bigger than or equal to 6.');
        }
    ...
    public function setJobTitle($job_title)
    {
        if (!is_null($job_title) && (mb_strlen($job_title) > 128)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling Body33., must be smaller than or equal to 128.');
        }
    ...
    public function setCompany($company)
    {
        if (!is_null($company) && (mb_strlen($company) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company when calling Body33., must be smaller than or equal to 255.');
        }
    ...
    public function setLocation($location)
    {
        if (!is_null($location) && (mb_strlen($location) > 256)) {
            throw new \InvalidArgumentException('invalid length for $location when calling Body33., must be smaller than or equal to 256.');
        }
