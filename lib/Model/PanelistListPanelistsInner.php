...
/**
 * PanelistListPanelistsInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class PanelistListPanelistsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PanelistList_panelists_inner';
     ...
     * Sets id
     *
     * @param string|null $id Panelist's ID.
     *
     * @return self
     */
     ...
     * Sets join_url
     *
     * @param string|null $join_url Join URL.
     *
     * @return self
     */
