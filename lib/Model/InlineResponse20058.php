...
class InlineResponse20058 implements ModelInterface, ArrayAccess
{
     ...
     * Sets message_id
     *
     * @param string|null $message_id Unique identifier of the message that was deleted.
     *
     * @return $this
     */
     ...
     * Sets robot_jid
     *
     * @param string|null $robot_jid The BotJID of the Chatbot app. It can be found in the Chat Subscription Section on the Features page of your App Dashboard
     *
     * @return $this
     */
     ...
     * Sets sent_time
     *
     * @param string|null $sent_time The date and time at which the message was deleted.
     *
     * @return $this
     */
     ...
     * Sets user_jid
     *
     * @param string|null $user_jid The UserJID of the user on whose behalf the message was sent. Used to prevent members of a channel from getting notifications that were set up by a user who has left the channel.
     *
     * @return $this
     */
