...
class InlineResponse20115 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_201_15';
     ...
     * Sets total_members
     *
     * @param int|null $total_members Total members assigned to the role.
     *
     * @return $this
     */
     ...
     * Sets privileges
     *
     * @param string[]|null $privileges [Privileges](https://marketplace.zoom.us/docs/api-reference/other-references/privileges) provided to the role.
     *
     * @return $this
     */
