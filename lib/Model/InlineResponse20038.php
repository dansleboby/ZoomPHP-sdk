...
class InlineResponse20038 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'uuid' => 'string',
        'start_time' => '\DateTime',
        'questions' => '\Zoom\Api\Model\InlineResponse20038Questions[]'
    ];
     ...
     * Sets uuid
     *
     * @param string $uuid Meeting UUID. Each meeting instance will generate its own UUID(i.e., after a meeting ends, a new UUID will be generated for the next instance of the meeting). Please double encode your UUID when using it for API calls if the UUID begins with a '/' or contains '//' in it.
     *
     * @return $this
     */
     ...
     * Gets questions
     *
     * @return \Zoom\Api\Model\InlineResponse20038Questions[]
     */
     ...
     * Sets questions
     *
     * @param \Zoom\Api\Model\InlineResponse20038Questions[] $questions Array of meeting question objects.
     *
     * @return $this
     */
