...
/**
 * MeetingRegistrantQuestionsQuestionsInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingRegistrantQuestionsQuestionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MeetingRegistrantQuestions_questions_inner';
     ...
     * Sets field_name
     *
     * @param string|null $field_name Field name of the question.
     *
     * @return self
     */
     ...
     * Sets required
     *
     * @param bool|null $required Indicates whether or not the displayed fields are required to be filled out by registrants.
     *
     * @return self
     */
