...
class InlineResponse2005Contacts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_5_contacts';
     ...
     *
     * @param string|null $presence_status Presence status of the contact in Zoom Client. The value of this field can be one of the following: `Do_Not_Disturb`<br> `away`<br> `Available`<br> `Offline`
     *
     * @return $this
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Phone number of the user.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $sip_phone_number SIP Phone number of the user. Returned only if user has SIP phone enabled.
     *
     * @return $this
     */
     ...
     * Sets direct_numbers
     *
     * @param string[]|null $direct_numbers Direct Number(s) of a user who has Zoom Phone license assigned.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $extension_number Extension Number of a user who has Zoom Phone license assigned.
     *
     * @return $this
     */
     ...
     * Sets im_group_name
     *
     * @param string|null $im_group_name Name of the [IM directory group](https://support.zoom.us/hc/en-us/articles/203749815-IM-Management) in which the user has been added. An IM Directory group is not the same as a channel. IM Directory allows administrators to assign users in their account to groups that display within the Contacts list on Zoom clients.
     *
     * @return $this
     */
     ...
     * Sets dept
     *
     * @param string|null $dept Department of the contact as provided in the user's Zoom profile.
     *
     * @return $this
     */
     ...
     * Sets job_title
     *
     * @param string|null $job_title Department of the user as provided in the user's Zoom profile.
     *
     * @return $this
     */
     ...
     * Sets location
     *
     * @param string|null $location Location of the user as provided in the user's Zoom profile.
     *
     * @return $this
     */
