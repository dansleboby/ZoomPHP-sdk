...
/**
 * RegistrantPost Class Doc Comment
 *
 * @category Class
 ...
 */
class RegistrantPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegistrantPost';
    ...
    public function setFirstName($first_name)
    {
        if ((mb_strlen($first_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling RegistrantPost., must be smaller than or equal to 64.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling RegistrantPost., must be smaller than or equal to 64.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 128)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RegistrantPost., must be smaller than or equal to 128.');
        }
