...
/**
 * ReportUsers200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class ReportUsers200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reportUsers_200_response';
     ...
     * Sets page_number
     *
     * @param int|null $page_number The page number of the current results.
     *
     * @return self
     */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ReportUsers200Response., must be smaller than or equal to 300.');
        }
