...
*ChatChannelsApi* | [**deleteUserLevelChannel**](docs/Api/ChatChannelsApi.md#deleteuserlevelchannel) | **DELETE** /chat/channels/{channelId} | Delete a Channel
*ChatChannelsApi* | [**getUserLevelChannel**](docs/Api/ChatChannelsApi.md#getuserlevelchannel) | **GET** /chat/channels/{channelId} | Get a Channel
...
*ChatChannelsApi* | [**removeAUserLevelChannelMember**](docs/Api/ChatChannelsApi.md#removeauserlevelchannelmember) | **DELETE** /chat/channels/{channelId}/members/{memberId} | Remove a Member
*ChatChannelsApi* | [**updateUserLevelChannel**](docs/Api/ChatChannelsApi.md#updateuserlevelchannel) | **PATCH** /chat/channels/{channelId} | Update a Channel
*ChatChannelsAccountLevelApi* | [**createChannel**](docs/Api/ChatChannelsAccountLevelApi.md#createchannel) | **POST** /chat/users/{userId}/channels | Create a Channel
*ChatChannelsAccountLevelApi* | [**deleteChannel**](docs/Api/ChatChannelsAccountLevelApi.md#deletechannel) | **DELETE** /chat/users/{userId}/channels/{channelId} | Delete a Channel
*ChatChannelsAccountLevelApi* | [**getChannel**](docs/Api/ChatChannelsAccountLevelApi.md#getchannel) | **GET** /chat/users/{userId}/channels/{channelId} | Get a Channel
*ChatChannelsAccountLevelApi* | [**getChannels**](docs/Api/ChatChannelsAccountLevelApi.md#getchannels) | **GET** /chat/users/{userId}/channels | List User&#39;s Channels
*ChatChannelsAccountLevelApi* | [**inviteChannelMembers**](docs/Api/ChatChannelsAccountLevelApi.md#invitechannelmembers) | **POST** /chat/users/{userId}/channels/{channelId}/members | Invite Channel Members
*ChatChannelsAccountLevelApi* | [**listChannelMembers**](docs/Api/ChatChannelsAccountLevelApi.md#listchannelmembers) | **GET** /chat/users/{userId}/channels/{channelId}/members | List Channel Members
*ChatChannelsAccountLevelApi* | [**removeAChannelMember**](docs/Api/ChatChannelsAccountLevelApi.md#removeachannelmember) | **DELETE** /chat/users/{userId}/channels/{channelId}/members/{memberId} | Remove a Member
*ChatChannelsAccountLevelApi* | [**updateChannel**](docs/Api/ChatChannelsAccountLevelApi.md#updatechannel) | **PATCH** /chat/users/{userId}/channels/{channelId} | Update a Channel
*ChatMessagesApi* | [**deleteChatMessage**](docs/Api/ChatMessagesApi.md#deletechatmessage) | **DELETE** /chat/users/{userId}/messages/{messageId} | Delete a Message
*ChatMessagesApi* | [**editMessage**](docs/Api/ChatMessagesApi.md#editmessage) | **PUT** /chat/users/{userId}/messages/{messageId} | Update a Message
...
*ChatMessagesApi* | [**sendaChatMessage**](docs/Api/ChatMessagesApi.md#sendachatmessage) | **POST** /chat/users/{userId}/messages | Send a Chat Message
...
*CommonAreaPhonesApi* | [**deleteCommonAreaPhone**](docs/Api/CommonAreaPhonesApi.md#deletecommonareaphone) | **DELETE** /phone/common_area_phones/{commonAreaPhoneId} | Delete a Common Area Phone
*CommonAreaPhonesApi* | [**getACommonAreaPhone**](docs/Api/CommonAreaPhonesApi.md#getacommonareaphone) | **GET** /phone/common_area_phones/{commonAreaPhoneId} | Get Common Area Phone Details
...
*CommonAreaPhonesApi* | [**updateCommonAreaPhone**](docs/Api/CommonAreaPhonesApi.md#updatecommonareaphone) | **PATCH** /phone/common_area_phones/{commonAreaPhoneId} | Update Common Area Phone
...
*DeprecatedAPIEndpointsApi* | [**listPastMeetingFiles**](docs/Api/DeprecatedAPIEndpointsApi.md#listpastmeetingfiles) | **GET** /past_meetings/{meetingId}/files | List Past Meeting Files
...
*MeetingsApi* | [**inMeetingRecordingControl**](docs/Api/MeetingsApi.md#inmeetingrecordingcontrol) | **PATCH** /live_meetings/{meetingId}/events | Use In-Meeting Recording Controls
...
*PhoneAutoReceptionistsApi* | [**addAutoReceptionist**](docs/Api/PhoneAutoReceptionistsApi.md#addautoreceptionist) | **POST** /phone/auto_receptionists | Add an Auto Receptionist
...
*PhoneCallQueuesApi* | [**getCallQueueRecordings**](docs/Api/PhoneCallQueuesApi.md#getcallqueuerecordings) | **GET** /phone/call_queues/{callQueueId}/recordings | Get Call Queue Recordings
...
*PhoneSharedLineGroupsApi* | [**addMembersToSharedLineGroup**](docs/Api/PhoneSharedLineGroupsApi.md#addmemberstosharedlinegroup) | **POST** /phone/shared_line_groups/{sharedLineGroupId}/members | Add Members to a Shared Line Group
*PhoneSharedLineGroupsApi* | [**assignPhoneNumbersSLG**](docs/Api/PhoneSharedLineGroupsApi.md#assignphonenumbersslg) | **POST** /phone/shared_line_groups/{sharedLineGroupId}/phone_numbers | Assign Phone Numbers
*PhoneSharedLineGroupsApi* | [**deleteAMemberSLG**](docs/Api/PhoneSharedLineGroupsApi.md#deleteamemberslg) | **DELETE** /phone/shared_line_groups/{sharedLineGroupId}/members/{memberId} | Unassign a Member From a Shared Line Group
*PhoneSharedLineGroupsApi* | [**deleteAPhoneNumberSLG**](docs/Api/PhoneSharedLineGroupsApi.md#deleteaphonenumberslg) | **DELETE** /phone/shared_line_groups/{sharedLineGroupId}/phone_numbers/{phoneNumberId} | Unassign a Phone Number
*PhoneSharedLineGroupsApi* | [**deleteASharedLineGroup**](docs/Api/PhoneSharedLineGroupsApi.md#deleteasharedlinegroup) | **DELETE** /phone/shared_line_groups/{sharedLineGroupId} | Delete a Shared Line Group
*PhoneSharedLineGroupsApi* | [**deleteMembersOfSLG**](docs/Api/PhoneSharedLineGroupsApi.md#deletemembersofslg) | **DELETE** /phone/shared_line_groups/{sharedLineGroupId}/members | Unassign Members of a Shared Line Group
*PhoneSharedLineGroupsApi* | [**getASharedLineGroup**](docs/Api/PhoneSharedLineGroupsApi.md#getasharedlinegroup) | **GET** /phone/shared_line_groups/{sharedLineGroupId} | Get a Shared Line Group
*PhoneSharedLineGroupsApi* | [**updateASharedLineGroup**](docs/Api/PhoneSharedLineGroupsApi.md#updateasharedlinegroup) | **PATCH** /phone/shared_line_groups/{sharedLineGroupId} | Update a Shared Line Group
...
*RoomsApi* | [**checkInRooms**](docs/Api/RoomsApi.md#checkinrooms) | **PATCH** /v2/rooms/{id}/events | Check-in or Check-out of a Zoom Room
...
*RoomsApi* | [**listDigitalSignageContent**](docs/Api/RoomsApi.md#listdigitalsignagecontent) | **GET** /rooms/digital_signage | List Digital Signage Contents
...
*RoomsDevicesApi* | [**changeZoomRoomsAppVersion**](docs/Api/RoomsDevicesApi.md#changezoomroomsappversion) | **PUT** /rooms/{roomId}/devices/{deviceId}/app_version | Change Zoom Rooms App Version
...
*SIPConnectedAudioApi* | [**addCalloutCountries**](docs/Api/SIPConnectedAudioApi.md#addcalloutcountries) | **POST** /accounts/{accountId}/sip_trunk/callout_countries | Add Internal Call-out Countries
*SIPConnectedAudioApi* | [**addInternalNumbers**](docs/Api/SIPConnectedAudioApi.md#addinternalnumbers) | **POST** /accounts/{accountId}/sip_trunk/internal_numbers | Add Internal Numbers
...
*SIPConnectedAudioApi* | [**assignSIPTrunks**](docs/Api/SIPConnectedAudioApi.md#assignsiptrunks) | **POST** /accounts/{accountId}/sip_trunk/trunks | Assign SIP Trunks
...
*SIPConnectedAudioApi* | [**deleteInternalCallOutCountry**](docs/Api/SIPConnectedAudioApi.md#deleteinternalcalloutcountry) | **DELETE** /accounts/{accountId}/sip_trunk/callout_countries/{countryId} | Delete Internal Call-out Country
*SIPConnectedAudioApi* | [**deleteInternalNumber**](docs/Api/SIPConnectedAudioApi.md#deleteinternalnumber) | **DELETE** /accounts/{accountId}/sip_trunk/internal_numbers/{numberId} | Delete an Internal Number
*SIPConnectedAudioApi* | [**deleteSIPTrunk**](docs/Api/SIPConnectedAudioApi.md#deletesiptrunk) | **DELETE** /accounts/{accountId}/sip_trunk/trunks/{trunkId} | Delete a SIP Trunk
*SIPConnectedAudioApi* | [**listInternalCalloutCountries**](docs/Api/SIPConnectedAudioApi.md#listinternalcalloutcountries) | **GET** /accounts/{accountId}/sip_trunk/callout_countries | List Internal Call-out Countries
*SIPConnectedAudioApi* | [**listInternalNumbers**](docs/Api/SIPConnectedAudioApi.md#listinternalnumbers) | **GET** /accounts/{accountId}/sip_trunk/internal_numbers | List Internal Numbers
*SIPConnectedAudioApi* | [**listSIPTrunks**](docs/Api/SIPConnectedAudioApi.md#listsiptrunks) | **GET** /accounts/{accountId}/sip_trunk/trunks | List SIP Trunks
...
## Documentation For Models
 ...
 - [AccountListAllOf](docs/Model/AccountListAllOf.md)
 - [AccountListAllOf1](docs/Model/AccountListAllOf1.md)
 ...
 - [AccountsAccountIdSipTrunkCalloutCountriesCalloutCountries](docs/Model/AccountsAccountIdSipTrunkCalloutCountriesCalloutCountries.md)
 - [AccountsAccountIdSipTrunkTrunksSipTrunks](docs/Model/AccountsAccountIdSipTrunkTrunksSipTrunks.md)
 ...
 - [ChatUsersUserIdChannelsChannelIdMembersMembers](docs/Model/ChatUsersUserIdChannelsChannelIdMembersMembers.md)
 - [ChatUsersUserIdChannelsMembers](docs/Model/ChatUsersUserIdChannelsMembers.md)
 - [CreateWebinar](docs/Model/CreateWebinar.md)
 - [CreateWebinarSettings](docs/Model/CreateWebinarSettings.md)
 - [CreateWebinarTrackingFields](docs/Model/CreateWebinarTrackingFields.md)
 ...
 - [GroupMemberListAllOfMembers](docs/Model/GroupMemberListAllOfMembers.md)
 ...
 - [IMGroupAllOf1](docs/Model/IMGroupAllOf1.md)
 ...
 - [InlineResponse200100Recordings](docs/Model/InlineResponse200100Recordings.md)
 - [InlineResponse200101](docs/Model/InlineResponse200101.md)
 - [InlineResponse200101SipTrunks](docs/Model/InlineResponse200101SipTrunks.md)
 - [InlineResponse200102](docs/Model/InlineResponse200102.md)
 - [InlineResponse200102CalloutCountries](docs/Model/InlineResponse200102CalloutCountries.md)
 - [InlineResponse200103](docs/Model/InlineResponse200103.md)
 - [InlineResponse200103InternalNumbers](docs/Model/InlineResponse200103InternalNumbers.md)
 - [InlineResponse200104](docs/Model/InlineResponse200104.md)
 - [InlineResponse200104Contents](docs/Model/InlineResponse200104Contents.md)
 - [InlineResponse200105](docs/Model/InlineResponse200105.md)
 - [InlineResponse200105Templates](docs/Model/InlineResponse200105Templates.md)
 ...
 - [InlineResponse20015PlanLargeMeeting](docs/Model/InlineResponse20015PlanLargeMeeting.md)
 ...
 - [InlineResponse20022TrackingFields](docs/Model/InlineResponse20022TrackingFields.md)
 ...
 - [InlineResponse20034CustomAttributes](docs/Model/InlineResponse20034CustomAttributes.md)
 ...
 - [InlineResponse20040Participants](docs/Model/InlineResponse20040Participants.md)
 ...
 - [InlineResponse20046CustomAttributes](docs/Model/InlineResponse20046CustomAttributes.md)
 ...
 - [InlineResponse2004ShortExtension](docs/Model/InlineResponse2004ShortExtension.md)
 ...
 - [InlineResponse20071SubAccountPrivileges](docs/Model/InlineResponse20071SubAccountPrivileges.md)
 ...
 - [InlineResponse20099Members](docs/Model/InlineResponse20099Members.md)
 - [InlineResponse20099MembersCommonAreaPhones](docs/Model/InlineResponse20099MembersCommonAreaPhones.md)
 - [InlineResponse20099MembersUsers](docs/Model/InlineResponse20099MembersUsers.md)
 - [InlineResponse20099PhoneNumbers](docs/Model/InlineResponse20099PhoneNumbers.md)
 - [InlineResponse20099Site](docs/Model/InlineResponse20099Site.md)
 ...
 - [InlineResponse20111Occurrences](docs/Model/InlineResponse20111Occurrences.md)
 - [InlineResponse20111Settings](docs/Model/InlineResponse20111Settings.md)
 - [InlineResponse20111SettingsGlobalDialInNumbers](docs/Model/InlineResponse20111SettingsGlobalDialInNumbers.md)
 - [InlineResponse20111TrackingFields](docs/Model/InlineResponse20111TrackingFields.md)
 - [InlineResponse20112](docs/Model/InlineResponse20112.md)
 - [InlineResponse20113](docs/Model/InlineResponse20113.md)
 - [InlineResponse20113Questions](docs/Model/InlineResponse20113Questions.md)
 ...
 - [InlineResponse20119Settings](docs/Model/InlineResponse20119Settings.md)
 - [InlineResponse20119TrackingFields](docs/Model/InlineResponse20119TrackingFields.md)
 ...
 - [InlineResponse20126](docs/Model/InlineResponse20126.md)
 - [InlineResponse20127](docs/Model/InlineResponse20127.md)
 - [InlineResponse20128](docs/Model/InlineResponse20128.md)
 - [InlineResponse20128SipTrunks](docs/Model/InlineResponse20128SipTrunks.md)
 - [InlineResponse20129](docs/Model/InlineResponse20129.md)
 - [InlineResponse20129CalloutCountries](docs/Model/InlineResponse20129CalloutCountries.md)
 - [InlineResponse2013](docs/Model/InlineResponse2013.md)
 - [InlineResponse20130](docs/Model/InlineResponse20130.md)
 - [InlineResponse20130InternalNumbers](docs/Model/InlineResponse20130InternalNumbers.md)
 ...
 - [InlineResponse2016PlanAudio](docs/Model/InlineResponse2016PlanAudio.md)
 - [InlineResponse2016PlanBase](docs/Model/InlineResponse2016PlanBase.md)
 - [InlineResponse2016PlanZoomRooms](docs/Model/InlineResponse2016PlanZoomRooms.md)
 ...
 - [MeetingAllOf](docs/Model/MeetingAllOf.md)
 ...
 - [MeetingListAllOf](docs/Model/MeetingListAllOf.md)
 ...
 - [MeetingUpdateAllOf](docs/Model/MeetingUpdateAllOf.md)
 ...
 - [ParticipantQOSAsDeviceFromCrc](docs/Model/ParticipantQOSAsDeviceFromCrc.md)
 - [ParticipantQOSAsDeviceToCrc](docs/Model/ParticipantQOSAsDeviceToCrc.md)
 - [ParticipantQOSAudioDeviceFromCrc](docs/Model/ParticipantQOSAudioDeviceFromCrc.md)
 - [ParticipantQOSAudioDeviceToCrc](docs/Model/ParticipantQOSAudioDeviceToCrc.md)
 ...
 - [ParticipantQOSVideoDeviceFromCrc](docs/Model/ParticipantQOSVideoDeviceFromCrc.md)
 - [ParticipantQOSVideoDeviceToCrc](docs/Model/ParticipantQOSVideoDeviceToCrc.md)
 ...
 - [PhonePlan2](docs/Model/PhonePlan2.md)
 - [PhonePlan2PlanBase](docs/Model/PhonePlan2PlanBase.md)
 - [PhonePlan2PlanCalling](docs/Model/PhonePlan2PlanCalling.md)
 - [PhonePlan2PlanNumber](docs/Model/PhonePlan2PlanNumber.md)
 - [PhoneSharedLineGroupsSharedLineGroupIdMembersMembers](docs/Model/PhoneSharedLineGroupsSharedLineGroupIdMembersMembers.md)
 - [PhoneSharedLineGroupsSharedLineGroupIdMembersMembersUsers](docs/Model/PhoneSharedLineGroupsSharedLineGroupIdMembersMembersUsers.md)
 - [PhoneSharedLineGroupsSharedLineGroupIdPrimaryNumber](docs/Model/PhoneSharedLineGroupsSharedLineGroupIdPrimaryNumber.md)
 - [PhoneSitesDefaultEmergencyAddress](docs/Model/PhoneSitesDefaultEmergencyAddress.md)
 - [PhoneSitesShortExtension](docs/Model/PhoneSitesShortExtension.md)
 ...
 - [QOSParticipantListAllOf1](docs/Model/QOSParticipantListAllOf1.md)
 ...
 - [RecordingMeetingListAllOf1](docs/Model/RecordingMeetingListAllOf1.md)
 - [RecordingMeetingListAllOf2](docs/Model/RecordingMeetingListAllOf2.md)
 ...
 - [TheH323SIPDeviceObject](docs/Model/TheH323SIPDeviceObject.md)
 ...
 - [UserListAllOf](docs/Model/UserListAllOf.md)
 ...
 - [UserSettingsRecordingSettingsRecordingPasswordRequirement](docs/Model/UserSettingsRecordingSettingsRecordingPasswordRequirement.md)
 ...
 - [UsersUserIdCustomAttributes](docs/Model/UsersUserIdCustomAttributes.md)
 ...
 - [V2RoomsIdEventsParams](docs/Model/V2RoomsIdEventsParams.md)
 ...
 - [WebinarAllOf](docs/Model/WebinarAllOf.md)
 ...
 - [WebinarUpdateAllOf](docs/Model/WebinarUpdateAllOf.md)
