...
/**
 * ReportOperationLogs200ResponseAllOfOperationLogsInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class ReportOperationLogs200ResponseAllOfOperationLogsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reportOperationLogs_200_response_allOf_operation_logs_inner';
     ...
     *
     * @param string|null $operation_detail Operation detail
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string|null $operator The user who performed the operation.
     *
     * @return self
     */
     ...
     * Sets time
     *
     * @param \DateTime|null $time The time at which the operation was performed.
     *
     * @return self
     */
