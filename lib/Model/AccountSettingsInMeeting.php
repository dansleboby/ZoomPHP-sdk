...
class AccountSettingsInMeeting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountSettings_in_meeting';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['meeting_reactions'] = isset($data['meeting_reactions']) ? $data['meeting_reactions'] : null;
        $this->container['show_a_join_from_your_browser_link'] = isset($data['show_a_join_from_your_browser_link']) ? $data['show_a_join_from_your_browser_link'] : null;
        $this->container['allow_participants_to_rename'] = isset($data['allow_participants_to_rename']) ? $data['allow_participants_to_rename'] : null;
     ...
     *
     * @param bool|null $attendee_on_hold Allow hosts to temporarily remove an attendee from a meeting.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $webinar_question_answer Allow a Q&A in a webinar.
     *
     * @return $this
     */
     ...
     * Sets auto_answer
     *
     * @param bool|null $auto_answer Enable users to see and add contacts to the \"auto-answer group\" in the chat contact list. Any call from members of this group will automatically be answered.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $allow_live_streaming Allow live streaming.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $workplace_by_facebook Workplace by facebook.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $custom_live_streaming_service Custom live streaming.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $custom_service_instructions Custom service instructions.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $data_center_regions If you have set the value of `custom_data_center_regions` to `true`, specify the data center regions that you would like to opt in to (country codes from among: [\"EU\", \"HK\", \"AU\", \"IN\", \"LA\", \"TY\", \"CN\", \"US\", \"CA\"]).
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $meeting_reactions Enable or disable meeting reactions. <br> `true`: Allow meeting participants to communicate without interrupting by reacting with an emoji that shows on their video.<br> `false`: Do not enable meeting reactions.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $show_a_join_from_your_browser_link If the value of this field is set to `true`, you will allow participants to join a meeting directly from their browser and bypass the Zoom application download process. This is a workaround for participants who are unable to download, install, or run applications. Note that the meeting experience from the browser is limited.
     *
     * @return $this
     */
