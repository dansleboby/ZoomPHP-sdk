 ...
 */
class AccountSettingsAuthenticationUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountSettingsAuthenticationUpdate';
