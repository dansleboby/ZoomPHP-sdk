...
class InlineResponse20070ScheduleMeeting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_70_schedule_meeting';
     ...
     * Sets enforce_login
     *
     * @param bool|null $enforce_login Allow only signed-in users to join meetings.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $enforce_login_with_domains Allow only signed-in users with specified domains to join meetings.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $enforce_login_domains Specify the domains from which users can join a meeting.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $not_store_meeting_topic Hide actual meeting topic and display \"Zoom Meeting\" for your scheduled meetings
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $require_password_for_scheduling_new_meetings This setting applies for regular meetings that do not use PMI. If enabled, a password will be generated while a host schedules a new meeting and participants will be required to enter the password before they can join the meeting. This setting is always enabled for free accounts and Pro accounts with a single host and cannot be modified for these accounts.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $require_password_for_instant_meetings Require password for instant meetings. If you use PMI for your instant meetings, this option will be disabled. This setting is always enabled for free accounts and Pro accounts with a single host and cannot be modified for these accounts.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $require_password_for_pmi_meetings Require participants to enter password for PMI meetings. This setting is always enabled for free accounts and Pro accounts with a single host and cannot be modified for these accounts.
     *
     * @return $this
     */
