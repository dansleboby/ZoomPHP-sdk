...
class InlineResponse20121 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_201_21';
     ...
     * Sets join_url
     *
     * @param string|null $join_url Unique URL for this registrant to join the Webinar. This URL should only be shared with the registrant for whom the API request was made.
     *
     * @return $this
     */
