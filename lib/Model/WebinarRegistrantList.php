 ...
 */
class WebinarRegistrantList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebinarRegistrantList';
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling WebinarRegistrantList., must be smaller than or equal to 300.');
        }
     ...
     * Sets registrants
     *
     * @param object[]|null $registrants List of registrant objects.
     *
     * @return self
     */
