...
/**
 * GetHotDeskUsage200ResponseTotalUsage Class Doc Comment
 *
 * @category Class
 * @description Information about the total workspace usage.
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetHotDeskUsage200ResponseTotalUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getHotDeskUsage_200_response_total_usage';
     ...
     * Sets in_use
     *
     * @param int|null $in_use The total number in use.
     *
     * @return self
     */
     ...
     * Sets not_in_use
     *
     * @param int|null $not_in_use The total number not in use.
     *
     * @return self
     */
