 ...
 */
class MeetingRecordingRegistrantList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MeetingRecordingRegistrantList';
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling MeetingRecordingRegistrantList., must be smaller than or equal to 300.');
        }
     ...
     * Sets registrants
     *
     * @param object[]|null $registrants Information about the cloud recording registrants.
     *
     * @return self
     */
