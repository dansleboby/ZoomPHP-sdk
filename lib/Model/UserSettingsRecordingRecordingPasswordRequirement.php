...
/**
 * UserSettingsRecordingRecordingPasswordRequirement Class Doc Comment
 *
 * @category Class
 ...
 */
class UserSettingsRecordingRecordingPasswordRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserSettingsRecording_recording_password_requirement';
     ...
     * Sets have_letter
     *
     * @param bool|null $have_letter Passcode must contain at least one alphabetical letter (a, b, c..).
     *
     * @return self
     */
     ...
     * Sets have_number
     *
     * @param bool|null $have_number Passcode must contain at least one number(1, 2, 3..).
     *
     * @return self
     */
     ...
     *
     * @param bool|null $have_special_character Passcode must contain at least one special character(!, @, #..).
     *
     * @return self
     */
     ...
     * Sets length
     *
     * @param int|null $length Minimum required length for the passcode.
     *
     * @return self
     */
    public function setLength($length)
    {
        ...
        if (!is_null($length) && ($length > 10)) {
            throw new \InvalidArgumentException('invalid value for $length when calling UserSettingsRecordingRecordingPasswordRequirement., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param bool|null $only_allow_numeric Passcode must contain only numeric characters.
     *
     * @return self
     */
