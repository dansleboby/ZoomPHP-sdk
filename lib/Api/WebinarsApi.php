...
class WebinarsApi
{
    ...
    public function getTrackingSourcesWithHttpInfo($webinar_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20074' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20074', []),
    ...
    public function listPastWebinarFilesWithHttpInfo($webinar_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20084' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20084', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function listPastWebinarPollResultsWithHttpInfo($webinar_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20085' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20085', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function listPastWebinarQAWithHttpInfo($webinar_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20086' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20086', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function listWebinarTemplatesWithHttpInfo($user_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse200105' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse200105', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listWebinarTemplatesRequest($user_id)
    {
    ...
    public function webinarWithHttpInfo($webinar_id, $occurrence_id = null, $show_previous_occurrences = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20054' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20054', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function webinarCreateWithHttpInfo($user_id, $body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Zoom\Api\Model\InlineResponse20119' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20119', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  \Zoom\Api\Model\InlineObject38 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  \Zoom\Api\Model\InlineObject38 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
    ...
    public function webinarPanelistsWithHttpInfo($webinar_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20055' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20055', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body Webinar poll object (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function webinarPollCreateWithHttpInfo($webinar_id, $body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Zoom\Api\Model\InlineResponse20122' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20122', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  string $poll_id The poll ID (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body Webinar Poll (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    public function webinarRegistrantCreateWithHttpInfo($webinar_id, $body, $occurrence_ids = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Zoom\Api\Model\InlineResponse20121' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20121', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function webinarRegistrantGetWithHttpInfo($webinar_id, $registrant_id, $occurrence_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\WebianrRegistrant' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\WebianrRegistrant', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body Webinar Registrant Questions (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  \Zoom\Api\Model\InlineObject39 $body body (required)
     * @param  string $occurrence_id The meeting occurrence ID. (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  \Zoom\Api\Model\InlineObject39 $body (required)
     * @param  string $occurrence_id The meeting occurrence ID. (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->webinarRegistrantsWithHttpInfo($webinar_id, $occurrence_id, $status, $page_size, $page_number, $next_page_token);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webinarRegistrantsAsync($webinar_id, $occurrence_id = null, $status = 'approved', $page_size = 30, $page_number = 1, $next_page_token = null)
    {
        return $this->webinarRegistrantsAsyncWithHttpInfo($webinar_id, $occurrence_id, $status, $page_size, $page_number, $next_page_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function webinarRegistrantsRequest($webinar_id, $occurrence_id = null, $status = 'approved', $page_size = 30, $page_number = 1, $next_page_token = null)
    {
        // verify the required parameter 'webinar_id' is set
        if ($webinar_id === null || (is_array($webinar_id) && count($webinar_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function webinarRegistrantsQuestionsGetWithHttpInfo($webinar_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20056' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20056', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  \Zoom\Api\Model\InlineObject37 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  \Zoom\Api\Model\InlineObject37 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  int $webinar_id The webinar ID in \&quot;**long**\&quot; format(represented as int64 data type in JSON). (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body Webinar. (required)
    ...
    public function webinarsWithHttpInfo($user_id, $page_size = 30, $page_number = 1)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\UserList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\UserList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
