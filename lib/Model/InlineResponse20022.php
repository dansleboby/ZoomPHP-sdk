...
class InlineResponse20022 implements ModelInterface, ArrayAccess
{
     ...
     * Sets assistant_id
     *
     * @param string $assistant_id Unique identifier of the scheduler who scheduled this meeting on behalf of the host. This field is only returned if you used \"schedule_for\" option in the [Create a Meeting API request](https://marketplace.zoom.us/docs/api-reference/zoom-api/meetings/meetingcreate).
     *
     * @return $this
     */
     ...
     *
     * @param string $encrypted_password Encrypted passcode for third party endpoints (H323/SIP).
     *
     * @return $this
     */
     ...
     * Sets h323_password
     *
     * @param string $h323_password H.323/SIP room system passcode.
     *
     * @return $this
     */
