 ...
 */
class RecordingRegistrantQuestions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecordingRegistrantQuestions';
