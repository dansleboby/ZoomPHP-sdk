...
class AccountSettingsInMeeting implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool $meeting_reactions Enable or disable meeting reactions. <br> `true`: Allow meeting participants to communicate without interrupting by reacting with an emoji that shows on their video.<br> `false`: Do not enable meeting reactions.
     *
     * @return $this
     */
     ...
     *
     * @param bool $allow_participants_to_rename If the value of this field is set to `true`, meeting participants and webinar panelists can be allowed to rename themselves during a meeting or a webinar.
     *
     * @return $this
     */
