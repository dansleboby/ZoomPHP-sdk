 ...
 */
class CreateWebinarSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateWebinarSettings';
     ...
     * Sets approval_type
     *
     * @param int|null $approval_type The default value is `2`. To enable registration required, set the approval type to `0` or `1`.  Values include:<br>  `0` - Automatically approve.<br>`1` - Manually approve.<br>`2` - No registration required.
     *
     * @return self
     */
     ...
     * Sets audio
     *
     * @param string|null $audio Determine how participants can join the audio portion of the meeting.
     *
     * @return self
     */
     ...
     * Sets enforce_login
     *
     * @param bool|null $enforce_login Only signed-in users can join this meeting.   **This field is deprecated and will not be supported in future.** <br><br> Instead of this field, use the \"meeting_authentication\", \"authentication_option\" and/or \"authentication_domains\" fields to establish the authentication mechanism for this Webinar.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param string|null $enforce_login_domains Only signed-in users with specified domains can join meetings.  **This field is deprecated and will not be supported in future.** <br><br> Instead of this field, use the \"authentication_domains\" field for this Webinar.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param bool|null $hd_video_for_attendees Whether HD video for attendees is enabled. This value defaults to `false`.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $meeting_authentication Only [authenticated](https://support.zoom.us/hc/en-us/articles/360037117472-Authentication-Profiles-for-Meetings-and-Webinars) users can join meeting if the value of this field is set to `true`.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $send_1080p_video_to_attendees Whether to always send 1080p video to attendees. This value defaults to `false`.
     *
     * @return self
     */
