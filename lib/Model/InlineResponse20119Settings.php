...
/**
 * InlineResponse20119Settings Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20119Settings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_201_19_settings';
    ...
    public function setRegistrantsRestrictNumber($registrants_restrict_number)
    {
        ...
        if (!is_null($registrants_restrict_number) && ($registrants_restrict_number > 20000)) {
            throw new \InvalidArgumentException('invalid value for $registrants_restrict_number when calling InlineResponse20119Settings., must be smaller than or equal to 20000.');
        }
        if (!is_null($registrants_restrict_number) && ($registrants_restrict_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $registrants_restrict_number when calling InlineResponse20119Settings., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param bool|null $meeting_authentication `true`- Only authenticated users can join Webinar.
     *
     * @return $this
     */
