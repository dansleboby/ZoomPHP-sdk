...
/**
 * WebinarSurveyCustomSurveyQuestionsInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class WebinarSurveyCustomSurveyQuestionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebinarSurvey_custom_survey_questions_inner';
    ...
    public function setAnswerMinCharacter($answer_min_character)
    {
        ...
        if (!is_null($answer_min_character) && ($answer_min_character < 1)) {
            throw new \InvalidArgumentException('invalid value for $answer_min_character when calling WebinarSurveyCustomSurveyQuestionsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setAnswers($answers)
    {
        ...
        if (!is_null($answers) && (count($answers) < 2)) {
            throw new \InvalidArgumentException('invalid length for $answers when calling WebinarSurveyCustomSurveyQuestionsInner., number of items must be greater than or equal to 2.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WebinarSurveyCustomSurveyQuestionsInner., must be smaller than or equal to 255.');
        }
    ...
    public function setRatingMaxValue($rating_max_value)
    {
        ...
        if (!is_null($rating_max_value) && ($rating_max_value > 10)) {
            throw new \InvalidArgumentException('invalid value for $rating_max_value when calling WebinarSurveyCustomSurveyQuestionsInner., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string|null $rating_min_label The low score label used for the `rating_min_value` field.    This field only applies to the `rating_scale` survey.
     *
     * @return self
     */
    ...
    public function setRatingMinValue($rating_min_value)
    {
        ...
        if (!is_null($rating_min_value) && ($rating_min_value < 0)) {
            throw new \InvalidArgumentException('invalid value for $rating_min_value when calling WebinarSurveyCustomSurveyQuestionsInner., must be bigger than or equal to 0.');
        }
