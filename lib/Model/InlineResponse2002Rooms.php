...
class InlineResponse2002Rooms implements ModelInterface, ArrayAccess
{
     ...
     * Sets location_id
     *
     * @param string $location_id Unique Identifier of the [location](https://marketplace.zoom.us/docs/api-reference/zoom-api/rooms-location/listzrlocations) of the room.
     *
     * @return $this
     */
