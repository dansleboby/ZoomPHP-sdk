...
/**
 * ListWebinarParticipants200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class ListWebinarParticipants200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listWebinarParticipants_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'page_count' => 'int',
        'page_size' => 'int',
        'participants' => '\Zoom\Api\Model\ListWebinarParticipants200ResponseParticipantsInner[]',
        'total_records' => 'int'
    ];
     ...
     * Sets page_count
     *
     * @param int|null $page_count The number of pages returned for this request.
     *
     * @return self
     */
     ...
     * Sets page_size
     *
     * @param int|null $page_size The total number of records returned from a single API call.
     *
     * @return self
     */
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ListWebinarParticipants200Response., must be smaller than or equal to 300.');
        }
     ...
     * Gets participants
     *
     * @return \Zoom\Api\Model\ListWebinarParticipants200ResponseParticipantsInner[]|null
     */
     ...
     * Sets participants
     *
     * @param \Zoom\Api\Model\ListWebinarParticipants200ResponseParticipantsInner[]|null $participants participants
     *
     * @return self
     */
     ...
     * Sets total_records
     *
     * @param int|null $total_records The total number of records available across all pages.
     *
     * @return self
     */
