...
class PhoneSitesDefaultEmergencyAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_phone_sites_default_emergency_address';
     ...
     * Sets address_line2
     *
     * @param string|null $address_line2 Address Line 2 of the [emergency address](https://support.zoom.us/hc/en-us/articles/360021062871-Setting-an-Emergency-Address) consisting of Building number, floor number, unit, etc.
     *
     * @return $this
     */
