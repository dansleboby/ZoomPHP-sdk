...
/**
 * AccountSettingsAuthenticationUpdateOneOf1AuthenticationOption Class Doc Comment
 *
 * @category Class
 ...
 */
class AccountSettingsAuthenticationUpdateOneOf1AuthenticationOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountSettingsAuthenticationUpdate_oneOf_1_authentication_option';
     ...
     * Sets domains
     *
     * @param string|null $domains If you chose `enforce_login_with_domains` as the authentication type, specify the domain(s) that you want to allow to view the recordings.
     *
     * @return self
     */
