...
class InlineResponse2001Phones implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_1_phones';
     ...
     * Sets user_email
     *
     * @param string|null $user_email The email address of the user to associate with the SIP Phone. Can add [.win, .mac, .android, .ipad, .iphone, .linux, .pc, .mobile, .pad] at the end of the email (ex. user@test.com.mac) to add accounts for different platforms for the same user.
     *
     * @return $this
     */
     ...
     * Sets domain
     *
     * @param string|null $domain The name or IP address of your provider’s SIP domain. (example: CDC.WEB).
     *
     * @return $this
     */
