...
/**
 * RecordingMeetingListAllOf1 Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class RecordingMeetingListAllOf1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecordingMeetingList_allOf_1';
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling RecordingMeetingListAllOf1., must be smaller than or equal to 300.');
        }
