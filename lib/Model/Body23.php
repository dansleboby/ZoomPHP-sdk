...
class Body23 implements ModelInterface, ArrayAccess
{
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 10)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Body23., must be smaller than or equal to 10.');
        }
    ...
    public function setAgenda($agenda)
    {
        if (!is_null($agenda) && (mb_strlen($agenda) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $agenda when calling Body23., must be smaller than or equal to 2000.');
        }
