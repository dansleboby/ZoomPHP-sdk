...
class ChatMessagesApi
{
     ...
     * @return void
     */
    public function deleteChatMessage($user_id, $message_id, $to_contact = null, $to_channel = null)
    {
        $this->deleteChatMessageWithHttpInfo($user_id, $message_id, $to_contact, $to_channel);
    }
     ...
     */
    public function deleteChatMessageWithHttpInfo($user_id, $message_id, $to_contact = null, $to_channel = null)
    {
        $request = $this->deleteChatMessageRequest($user_id, $message_id, $to_contact, $to_channel);
     ...
     */
    public function deleteChatMessageAsync($user_id, $message_id, $to_contact = null, $to_channel = null)
    {
        return $this->deleteChatMessageAsyncWithHttpInfo($user_id, $message_id, $to_contact, $to_channel)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteChatMessageAsyncWithHttpInfo($user_id, $message_id, $to_contact = null, $to_channel = null)
    {
        $returnType = '';
        $request = $this->deleteChatMessageRequest($user_id, $message_id, $to_contact, $to_channel);
     ...
     */
    protected function deleteChatMessageRequest($user_id, $message_id, $to_contact = null, $to_channel = null)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_id when calling deleteChatMessage'
            );
        }
        ...
        $resourcePath = '/chat/users/{userId}/messages/{messageId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if (is_array($to_contact)) {
            $to_contact = ObjectSerializer::serializeCollection($to_contact, '', true);
        }
        if ($to_contact !== null) {
            $queryParams['to_contact'] = $to_contact;
        }
        // query params
        if (is_array($to_channel)) {
            $to_channel = ObjectSerializer::serializeCollection($to_channel, '', true);
        }
        if ($to_channel !== null) {
            $queryParams['to_channel'] = $to_channel;
        }
     ...
     * @param  \Zoom\Api\Model\InlineObject6 $body body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function editMessage($user_id, $message_id, $body = null)
    {
        $this->editMessageWithHttpInfo($user_id, $message_id, $body);
    }
     ...
     * @param  string $user_id (required)
     * @param  string $message_id Message ID: Unique Identifier of the message. (required)
     * @param  \Zoom\Api\Model\InlineObject6 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function editMessageWithHttpInfo($user_id, $message_id, $body = null)
    {
        $request = $this->editMessageRequest($user_id, $message_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function editMessageAsync($user_id, $message_id, $body = null)
    {
        return $this->editMessageAsyncWithHttpInfo($user_id, $message_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function editMessageAsyncWithHttpInfo($user_id, $message_id, $body = null)
    {
        $returnType = '';
        $request = $this->editMessageRequest($user_id, $message_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function editMessageRequest($user_id, $message_id, $body = null)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_id when calling editMessage'
            );
        }
        // verify the required parameter 'message_id' is set
        if ($message_id === null || (is_array($message_id) && count($message_id) === 0)) {
     ...
     * @param  \DateTime $date The query date for which you would like to get the chat messages. (optional)
    ...
    {
        list($response) = $this->getChatMessagesWithHttpInfo($user_id, $to_contact, $to_channel, $date, $page_size, $next_page_token);
        return $response;
    }
    ...
    public function getChatMessagesWithHttpInfo($user_id, $to_contact = null, $to_channel = null, $date = null, $page_size = 10, $next_page_token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse2006' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse2006', []),
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChatMessagesAsync($user_id, $to_contact = null, $to_channel = null, $date = null, $page_size = 10, $next_page_token = null)
    {
        return $this->getChatMessagesAsyncWithHttpInfo($user_id, $to_contact, $to_channel, $date, $page_size, $next_page_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getChatMessagesRequest($user_id, $to_contact = null, $to_channel = null, $date = null, $page_size = 10, $next_page_token = null)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $user_id user_id (required)
     * @param  \Zoom\Api\Model\InlineObject5 $body body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->sendaChatMessageWithHttpInfo($user_id, $body);
        return $response;
    }
     ...
     *
     * @param  string $user_id (required)
     * @param  \Zoom\Api\Model\InlineObject5 $body (optional)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function sendaChatMessageWithHttpInfo($user_id, $body = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Zoom\Api\Model\InlineResponse2011' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse2011', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendaChatMessageAsync($user_id, $body = null)
    {
        return $this->sendaChatMessageAsyncWithHttpInfo($user_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendaChatMessageRequest($user_id, $body = null)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_id when calling sendaChatMessage'
            );
        }
