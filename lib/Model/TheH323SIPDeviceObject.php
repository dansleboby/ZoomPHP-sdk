...
/**
 * TheH323SIPDeviceObject Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class TheH323SIPDeviceObject implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'The_H_323_SIP_device_object_';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TheH323SIPDeviceObject., must be smaller than or equal to 64.');
        }
