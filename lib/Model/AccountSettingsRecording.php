...
class AccountSettingsRecording implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool $allow_recovery_deleted_cloud_recordings Allow recovery of deleted cloud recordings from trash.  If the value of this field is set to `true`, deleted cloud recordings will be kept in trash for 30 days after deletion and can be recovered within that period.
     *
     * @return $this
     */
     ...
     *
     * @param bool $recording_disclaimer Show a disclaimer to participants before a recording starts
     *
     * @return $this
     */
     ...
     *
     * @param bool $host_delete_cloud_recording If the value of this field is set to `true`, hosts will be able to delete the recordings. If this option is set to `false`, the recordings cannot be deleted by the host and only admin can delete them.
     *
     * @return $this
     */
     ...
     *
     * @param bool $required_password_for_existing_cloud_recordings required_password_for_existing_cloud_recordings
     *
     * @return $this
     */
