...
/**
 * WebinarPollCreate201Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class WebinarPollCreate201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webinarPollCreate_201_response';
     ...
     * Sets id
     *
     * @param string|null $id Webinar Poll ID
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the Webinar Poll:<br>`notstart` - Poll not started<br>`started` - Poll started<br>`ended` - Poll ended<br>`sharing` - Sharing poll results
     *
     * @return self
     */
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 64)) {
            throw new \InvalidArgumentException('invalid length for $title when calling WebinarPollCreate201Response., must be smaller than or equal to 64.');
        }
