 ...
 * @link     https://openapi-generator.tech
 */
class InlineObject33 implements ModelInterface, ArrayAccess
{
     ...
     * Sets first_name
     *
     * @param string|null $first_name User's first name. Cannot contain more than 5 Chinese characters.
     *
     * @return $this
     */
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling InlineObject33., must be smaller than or equal to 64.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name User's last name. Cannot contain more than 5 Chinese characters.
     *
     * @return $this
     */
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling InlineObject33., must be smaller than or equal to 64.');
        }
     ...
     * Sets type
     *
     * @param int|null $type User types:<br>`1` - Basic.<br>`2` - Licensed.<br>`3` - On-prem.
     *
     * @return $this
     */
     ...
     * Sets pmi
     *
     * @param int|null $pmi Personal meeting ID: length must be 10.
     *
     * @return $this
     */
     ...
     * Sets use_pmi
     *
     * @param bool|null $use_pmi Use Personal Meeting ID for instant meetings.
     *
     * @return $this
     */
     ...
     * Sets timezone
     *
     * @param string|null $timezone The time zone ID for a user profile. For this parameter value please refer to the ID value in the [timezone](https://marketplace.zoom.us/docs/api-reference/other-references/abbreviation-lists#timezones) list.
     *
     * @return $this
     */
     ...
     * Sets dept
     *
     * @param string|null $dept Department for user profile: use for report.
     *
     * @return $this
     */
     ...
     * Sets vanity_name
     *
     * @param string|null $vanity_name Personal meeting room name.
     *
     * @return $this
     */
     ...
     * Sets host_key
     *
     * @param string|null $host_key Host key. It should be a 6-10 digit number.
     *
     * @return $this
     */
    public function setHostKey($host_key)
    {
        if (!is_null($host_key) && (mb_strlen($host_key) > 10)) {
            throw new \InvalidArgumentException('invalid length for $host_key when calling InlineObject33., must be smaller than or equal to 10.');
        }
        if (!is_null($host_key) && (mb_strlen($host_key) < 6)) {
            throw new \InvalidArgumentException('invalid length for $host_key when calling InlineObject33., must be bigger than or equal to 6.');
        }
     ...
     * Sets cms_user_id
     *
     * @param string|null $cms_user_id Kaltura user ID.
     *
     * @return $this
     */
    ...
    public function setJobTitle($job_title)
    {
        if (!is_null($job_title) && (mb_strlen($job_title) > 128)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling InlineObject33., must be smaller than or equal to 128.');
        }
    ...
    public function setCompany($company)
    {
        if (!is_null($company) && (mb_strlen($company) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company when calling InlineObject33., must be smaller than or equal to 255.');
        }
    ...
    public function setLocation($location)
    {
        if (!is_null($location) && (mb_strlen($location) > 256)) {
            throw new \InvalidArgumentException('invalid length for $location when calling InlineObject33., must be smaller than or equal to 256.');
        }
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Phone number of the user. To update a phone number, you must also provide the `phone_country` field.
     *
     * @return $this
     */
     ...
     * Sets phone_country
     *
     * @param string|null $phone_country [Country ID](https://marketplace.zoom.us/docs/api-reference/other-references/abbreviation-lists#countries) of the phone number. For example, if the phone number provided in the `phone_number` field is a Brazil based number, the value of the `phone_country` field should be `BR`.
     *
     * @return $this
     */
     ...
     *
     * @return \Zoom\Api\Model\UsersUserIdCustomAttributes|null
     */
     ...
     *
     * @param \Zoom\Api\Model\UsersUserIdCustomAttributes|null $custom_attributes custom_attributes
     *
     * @return $this
     */
