...
class AccountsOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_accounts_options';
     ...
     * Sets share_rc
     *
     * @param bool|null $share_rc Enable/disable the option for a Sub Account to use shared [Virtual Room Connector(s)](https://support.zoom.us/hc/en-us/articles/202134758-Getting-Started-With-Virtual-Room-Connector) that are set up by the Master Account. Virtual Room Connectors can only be used by On-prem users.
     *
     * @return $this
     */
     ...
     * Sets share_mc
     *
     * @param bool|null $share_mc Enable/disable the option for a Sub Account to use shared [Meeting Connector(s)](https://support.zoom.us/hc/en-us/articles/201363093-Getting-Started-with-the-Meeting-Connector) that are set up by the Master Account. Meeting Connectors can only be used by On-prem users.
     *
     * @return $this
     */
     ...
     * Sets pay_mode
     *
     * @param string|null $pay_mode Payee:<br>`master` - Master account holder pays.<br>`sub` - Sub account holder pays.
     *
     * @return $this
     */
