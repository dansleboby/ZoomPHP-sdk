...
/**
 * MeetingWebinarSecurityGroupSettingsMeetingSecurity Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingWebinarSecurityGroupSettingsMeetingSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Meeting_Webinar_Security_Group_Settings_meeting_security';
    ...
    protected static $openAPITypes = [
        ...
        'chat_etiquette_tool' => '\Zoom\Api\Model\MeetingWebinarSecurityGroupSettingsMeetingSecurityChatEtiquetteTool',
        ...
        'waiting_room' => 'bool',
        'waiting_room_settings' => '\Zoom\Api\Model\MeetingWebinarSecurityGroupSettingsMeetingSecurityWaitingRoomSettings',
     ...
     * Sets auto_security
     *
     * @param bool|null $auto_security Whether all meetings are required to be secured with at least one security option.    This setting can only be disabled by Enterprise, ISV, Business (with more than 100 licenses), and Education accounts.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $block_user_domain_list A list of blocked domains.
     *
     * @return self
     */
    public function setBlockUserDomainList($block_user_domain_list)
    {
        ...
        if (!is_null($block_user_domain_list) && (count($block_user_domain_list) > 20)) {
            throw new \InvalidArgumentException('invalid value for $block_user_domain_list when calling MeetingWebinarSecurityGroupSettingsMeetingSecurity., number of items must be less than or equal to 20.');
        }
     ...
     *
     * @return \Zoom\Api\Model\MeetingWebinarSecurityGroupSettingsMeetingSecurityChatEtiquetteTool|null
     */
     ...
     *
     * @param \Zoom\Api\Model\MeetingWebinarSecurityGroupSettingsMeetingSecurityChatEtiquetteTool|null $chat_etiquette_tool chat_etiquette_tool
     *
     * @return self
     */
     ...
     * Sets phone_password
     *
     * @param bool|null $phone_password Whether a password is required for participants joining by phone.    If enabled and the meeting is password-protected, a numeric password is required for participants to join by phone. For meetings with alphanumeric passwords, a numeric password will be generated.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $require_password_for_scheduled_meeting Whether a password is required for meetings that have already been scheduled.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $require_password_for_scheduled_webinar Whether a password is required for webinars that have already been scheduled.
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\MeetingWebinarSecurityGroupSettingsMeetingSecurityWaitingRoomSettings|null
     */
     ...
     *
     * @param \Zoom\Api\Model\MeetingWebinarSecurityGroupSettingsMeetingSecurityWaitingRoomSettings|null $waiting_room_settings waiting_room_settings
     *
     * @return self
     */
     ...
     *
     * @param bool|null $webinar_password Whether a password is generated when scheduling webinars. Participants must use the generated password to join the scheduled webinar.
     *
     * @return self
     */
