...
/**
 * WebinarUpdateAllOf Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class WebinarUpdateAllOf implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebinarUpdate_allOf';
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 10)) {
            throw new \InvalidArgumentException('invalid length for $password when calling WebinarUpdateAllOf., must be smaller than or equal to 10.');
        }
