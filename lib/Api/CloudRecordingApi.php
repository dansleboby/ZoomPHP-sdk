...
class CloudRecordingApi
{
    ...
    public function getAccountCloudRecordingWithHttpInfo($account_id, $page_size = 30, $next_page_token = null, $from = null, $to = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\InlineResponse20073' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20073', []),
    ...
    public function meetingRecordingRegistrantCreateWithHttpInfo($meeting_id, $body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Zoom\Api\Model\InlineResponse20114' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\InlineResponse20114', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject28 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  int $meeting_id The meeting ID in **long** format. The data type of this field is \&quot;long\&quot;(represented as int64 in JSON).  While storing it in your database, store it as a **long** data type and **not as an integer**, as the Meeting IDs can be longer than 10 digits. (required)
     * @param  \Zoom\Api\Model\InlineObject28 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function meetingRecordingRegistrantsWithHttpInfo($meeting_id, $status = 'approved', $page_size = 30, $page_number = 1, $next_page_token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\RegistrationList1' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\RegistrationList1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function meetingRecordingRegistrantsRequest($meeting_id, $status = 'approved', $page_size = 30, $page_number = 1, $next_page_token = null)
    {
        // verify the required parameter 'meeting_id' is set
        if ($meeting_id === null || (is_array($meeting_id) && count($meeting_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $meeting_id To get Cloud Recordings of a meeting, provide the meeting ID or meeting UUID. If the meeting ID is provided instead of UUID,the response will be for the latest meeting instance.   To get Cloud Recordings of a webinar, provide the webinar ID or the webinar UUID. If the webinar ID is provided instead of UUID,the response will be for the latest webinar instance.   If a UUID starts with \&quot;/\&quot; or contains \&quot;//\&quot; (example: \&quot;/ajXp112QmuoKj4854875&#x3D;&#x3D;\&quot;), you must **double encode** the UUID before making an API request. (required)
     * @param  \Zoom\Api\Model\UNKNOWN_BASE_TYPE $body Recording Registrant Questions (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $meeting_id To get Cloud Recordings of a meeting, provide the meeting ID or meeting UUID. If the meeting ID is provided instead of UUID,the response will be for the latest meeting instance.   To get Cloud Recordings of a webinar, provide the webinar ID or the webinar UUID. If the webinar ID is provided instead of UUID,the response will be for the latest webinar instance.   If a UUID starts with \&quot;/\&quot; or contains \&quot;//\&quot; (example: \&quot;/ajXp112QmuoKj4854875&#x3D;&#x3D;\&quot;), you must **double encode** the UUID before making an API request. (required)
     * @param  \Zoom\Api\Model\RecordingSettings1 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $meeting_id To get Cloud Recordings of a meeting, provide the meeting ID or meeting UUID. If the meeting ID is provided instead of UUID,the response will be for the latest meeting instance.   To get Cloud Recordings of a webinar, provide the webinar ID or the webinar UUID. If the webinar ID is provided instead of UUID,the response will be for the latest webinar instance.   If a UUID starts with \&quot;/\&quot; or contains \&quot;//\&quot; (example: \&quot;/ajXp112QmuoKj4854875&#x3D;&#x3D;\&quot;), you must **double encode** the UUID before making an API request. (required)
     * @param  \Zoom\Api\Model\RecordingSettings1 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $meeting_id To get Cloud Recordings of a meeting, provide the meeting ID or meeting UUID. If the meeting ID is provided instead of UUID,the response will be for the latest meeting instance.   To get Cloud Recordings of a webinar, provide the webinar ID or the webinar UUID. If the webinar ID is provided instead of UUID,the response will be for the latest webinar instance.   If a UUID starts with \&quot;/\&quot; or contains \&quot;//\&quot; (example: \&quot;/ajXp112QmuoKj4854875&#x3D;&#x3D;\&quot;), you must **double encode** the UUID before making an API request. (required)
     * @param  \Zoom\Api\Model\InlineObject26 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $meeting_id To get Cloud Recordings of a meeting, provide the meeting ID or meeting UUID. If the meeting ID is provided instead of UUID,the response will be for the latest meeting instance.   To get Cloud Recordings of a webinar, provide the webinar ID or the webinar UUID. If the webinar ID is provided instead of UUID,the response will be for the latest webinar instance.   If a UUID starts with \&quot;/\&quot; or contains \&quot;//\&quot; (example: \&quot;/ajXp112QmuoKj4854875&#x3D;&#x3D;\&quot;), you must **double encode** the UUID before making an API request. (required)
     * @param  \Zoom\Api\Model\InlineObject26 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  string $meeting_id To get Cloud Recordings of a meeting, provide the meeting ID or meeting UUID. If the meeting ID is provided instead of UUID,the response will be for the latest meeting instance.   To get Cloud Recordings of a webinar, provide the webinar ID or the webinar UUID. If the webinar ID is provided instead of UUID,the response will be for the latest webinar instance.   If a UUID starts with \&quot;/\&quot; or contains \&quot;//\&quot; (example: \&quot;/ajXp112QmuoKj4854875&#x3D;&#x3D;\&quot;), you must **double encode** the UUID before making an API request. (required)
     * @param  string $recording_id The recording ID. (required)
     * @param  \Zoom\Api\Model\InlineObject27 $body body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $meeting_id To get Cloud Recordings of a meeting, provide the meeting ID or meeting UUID. If the meeting ID is provided instead of UUID,the response will be for the latest meeting instance.   To get Cloud Recordings of a webinar, provide the webinar ID or the webinar UUID. If the webinar ID is provided instead of UUID,the response will be for the latest webinar instance.   If a UUID starts with \&quot;/\&quot; or contains \&quot;//\&quot; (example: \&quot;/ajXp112QmuoKj4854875&#x3D;&#x3D;\&quot;), you must **double encode** the UUID before making an API request. (required)
     * @param  string $recording_id The recording ID. (required)
     * @param  \Zoom\Api\Model\InlineObject27 $body (required)
     *
     * @throws \Zoom\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
    ...
    public function recordingsListWithHttpInfo($user_id, $page_size = 30, $next_page_token = null, $mc = 'false', $trash = false, $from = null, $to = null, $trash_type = 'meeting_recordings')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Zoom\Api\Model\RecordingList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Zoom\Api\Model\RecordingList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    protected function recordingsListRequest($user_id, $page_size = 30, $next_page_token = null, $mc = 'false', $trash = false, $from = null, $to = null, $trash_type = 'meeting_recordings')
    {
        ...
        // query params
        if (is_array($mc)) {
            $mc = ObjectSerializer::serializeCollection($mc, '', true);
        }
        if ($mc !== null) {
            $queryParams['mc'] = $mc;
        }
        // query params
        if (is_array($trash)) {
            $trash = ObjectSerializer::serializeCollection($trash, '', true);
        }
        if ($trash !== null) {
            $queryParams['trash'] = $trash;
        }
        // query params
        if (is_array($from)) {
            $from = ObjectSerializer::serializeCollection($from, '', true);
        ...
        // query params
        if (is_array($trash_type)) {
            $trash_type = ObjectSerializer::serializeCollection($trash_type, '', true);
        }
        if ($trash_type !== null) {
            $queryParams['trash_type'] = $trash_type;
        }
