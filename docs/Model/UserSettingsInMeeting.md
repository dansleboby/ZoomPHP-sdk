...
**closed_captioning** | [**\Zoom\Api\Model\UserSettingsInMeetingClosedCaptioning**](UserSettingsInMeetingClosedCaptioning.md) |  | [optional]
...
**language_interpretation** | [**\Zoom\Api\Model\UserSettingsInMeetingLanguageInterpretation**](UserSettingsInMeetingLanguageInterpretation.md) |  | [optional]
...
**virtual_background_settings** | [**\Zoom\Api\Model\UserSettingsInMeetingVirtualBackgroundSettings**](UserSettingsInMeetingVirtualBackgroundSettings.md) |  | [optional]
**waiting_room** | **bool** | Enable Waiting room - if enabled, attendees can only join after host approves. | [optional] [default to false]
**webinar_chat** | [**\Zoom\Api\Model\UserSettingsInMeetingWebinarChat**](UserSettingsInMeetingWebinarChat.md) |  | [optional]
**webinar_live_streaming** | [**\Zoom\Api\Model\UserSettingsInMeetingWebinarLiveStreaming**](UserSettingsInMeetingWebinarLiveStreaming.md) |  | [optional]
**webinar_polling** | [**\Zoom\Api\Model\UserSettingsInMeetingWebinarPolling**](UserSettingsInMeetingWebinarPolling.md) |  | [optional]
