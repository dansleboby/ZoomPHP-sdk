...
/**
 * UpdateZRLocationProfileRequestBasic Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class UpdateZRLocationProfileRequestBasic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateZRLocationProfile_request_basic';
     ...
     * Sets address
     *
     * @param string|null $address Address. Can only be updated for Campus and Building.
     *
     * @return self
     */
    ...
    public function setRoomPasscode($room_passcode)
    {
        if (!is_null($room_passcode) && (mb_strlen($room_passcode) > 16)) {
            throw new \InvalidArgumentException('invalid length for $room_passcode when calling UpdateZRLocationProfileRequestBasic., must be smaller than or equal to 16.');
        }
        if (!is_null($room_passcode) && (mb_strlen($room_passcode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $room_passcode when calling UpdateZRLocationProfileRequestBasic., must be bigger than or equal to 1.');
        }
     ...
     * Sets timezone
     *
     * @param string|null $timezone Timezone (can only be updated for location type - city).
     *
     * @return self
     */
