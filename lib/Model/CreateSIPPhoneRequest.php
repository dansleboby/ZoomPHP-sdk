...
/**
 * CreateSIPPhoneRequest Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class CreateSIPPhoneRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSIPPhone_request';
    ...
    public function setAuthorizationName($authorization_name)
    {
        if ((mb_strlen($authorization_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $authorization_name when calling CreateSIPPhoneRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setDomain($domain)
    {
        if ((mb_strlen($domain) > 64)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling CreateSIPPhoneRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setRegistrationExpireTime($registration_expire_time)
    {
        ...
        if (!is_null($registration_expire_time) && ($registration_expire_time > 127)) {
            throw new \InvalidArgumentException('invalid value for $registration_expire_time when calling CreateSIPPhoneRequest., must be smaller than or equal to 127.');
        }
        if (!is_null($registration_expire_time) && ($registration_expire_time < 1)) {
            throw new \InvalidArgumentException('invalid value for $registration_expire_time when calling CreateSIPPhoneRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets user_email
     *
     * @param string $user_email The email address of the user to associate with the SIP Phone. Can add `.win`, `.mac`, `.android`, `.ipad`, `.iphone`, `.linux`, `.pc`, `.mobile`, `.pad` at the end of the email (for example, `user@example.com.mac`) to add accounts for different platforms for the same user.
     *
     * @return self
     */
    public function setUserEmail($user_email)
    {
        if ((mb_strlen($user_email) > 64)) {
            throw new \InvalidArgumentException('invalid length for $user_email when calling CreateSIPPhoneRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setUserName($user_name)
    {
        if ((mb_strlen($user_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling CreateSIPPhoneRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setVoiceMail($voice_mail)
    {
        if ((mb_strlen($voice_mail) > 255)) {
            throw new \InvalidArgumentException('invalid length for $voice_mail when calling CreateSIPPhoneRequest., must be smaller than or equal to 255.');
        }
