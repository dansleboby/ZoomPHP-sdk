...
/**
 * UserInMeetingSettingsWebinarChat Class Doc Comment
 *
 * @category Class
 ...
 */
class UserInMeetingSettingsWebinarChat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_In_Meeting_Settings_webinar_chat';
     ...
     *
     * @param bool|null $allow_auto_save_local_chat_file Automatically save chat messages to a local file on the host's computer when the webinar ends.
     *
     * @return self
     */
     ...
     *
     * @param int|null $allow_panelists_chat_with Who webinar panelists can chat with: * `1` — Host and all panelists. * `2` — Everyone.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $allow_panelists_send_direct_message Allow webinar panelists to send direct messages to other panelists.
     *
     * @return self
     */
     ...
     *
     * @param int|null $allow_users_save_chats How webinar attendees can save chats: * `0` — Attendees cannot save chats. * `1` — Attendees can only save host and panelist chats. * `2` — Attendees can save all chats.
     *
     * @return self
     */
     ...
     * Sets enable
     *
     * @param bool|null $enable Allow webinar participants to send chat messages.
     *
     * @return self
     */
