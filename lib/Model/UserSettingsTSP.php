 ...
 */
class UserSettingsTSP implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param mixed[]|null $call_out_countries Call Out Countries/Regions
     *
     * @return self
     */
