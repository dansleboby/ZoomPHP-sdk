...
class InlineResponse20119 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'settings' => '\Swagger\Client\Model\InlineResponse20119Settings',
        'start_time' => '\DateTime',
        'start_url' => 'string',
        'template_id' => 'string',
        'timezone' => 'string',
     ...
     * Sets host_email
     *
     * @param string $host_email Email address of the meeting host.
     *
     * @return $this
     */
     ...
     *
     * @param bool $registrants_confirmation_email Specify whether or not registrants of this Webinar should receieve confirmation emails.
     *
     * @return $this
     */
     ...
     * Gets settings
     *
     * @return \Swagger\Client\Model\InlineResponse20119Settings
     */
     ...
     * Sets settings
     *
     * @param \Swagger\Client\Model\InlineResponse20119Settings $settings settings
     *
     * @return $this
     */
     ...
     * Sets template_id
     *
     * @param string $template_id Unique identifier of the Webinar template. Use this field only if you would like to [schedule the webinar using an existing template](https://support.zoom.us/hc/en-us/articles/115001079746-Webinar-Templates#schedule). The value of this field can be retrieved from List
     *
     * @return $this
     */
     ...
     * Sets uuid
     *
     * @param string $uuid Unique identifier for a Webinar. Each Webinar instance will generate its own UUID(i.e., after a Webinar ends, a new UUID will be generated for the next instance of the Webinar). Once a Webinar ends, the value of uuid for the same webinar will be different from when it was scheduled.
     *
     * @return $this
     */
