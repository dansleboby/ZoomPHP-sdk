...
/**
 * MeetingPollCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingPollCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'meetingPollCreate_request';
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 64)) {
            throw new \InvalidArgumentException('invalid length for $title when calling MeetingPollCreateRequest., must be smaller than or equal to 64.');
        }
