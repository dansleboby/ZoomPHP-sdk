...
/**
 * Meeting200Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class Meeting200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'meeting_200_response';
    ...
    public function setAgenda($agenda)
    {
        if (!is_null($agenda) && (mb_strlen($agenda) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $agenda when calling Meeting200Response., must be smaller than or equal to 2000.');
        }
