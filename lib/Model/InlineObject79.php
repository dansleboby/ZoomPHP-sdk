 ...
 * @link     https://openapi-generator.tech
 */
class InlineObject79 implements ModelInterface, ArrayAccess
{
     ...
     * Gets primary_number
     *
     * @return \Zoom\Api\Model\PhoneSharedLineGroupsSharedLineGroupIdPrimaryNumber|null
     */
     ...
     * Sets primary_number
     *
     * @param \Zoom\Api\Model\PhoneSharedLineGroupsSharedLineGroupIdPrimaryNumber|null $primary_number primary_number
     *
     * @return $this
     */
     ...
     * Sets timezone
     *
     * @param string|null $timezone Timezone to be used for the Business Hours. A value should be provided from the IDs listed [here](https://marketplace.zoom.us/docs/api-reference/other-references/abbreviation-lists#timezones).
     *
     * @return $this
     */
