...
/**
 * TspUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class TspUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tspUpdate_request';
     ...
     * Sets enable
     *
     * @param bool|null $enable Enable 3rd party audio conferencing for account users
     *
     * @return self
     */
     ...
     * Sets tsp_provider
     *
     * @param string|null $tsp_provider 3rd party audio conferencing provider
     *
     * @return self
     */
