...
/**
 * UserSettingsAudioConferenceTollFreeAndFeeBasedTollCall Class Doc Comment
 *
 * @category Class
 ...
 */
class UserSettingsAudioConferenceTollFreeAndFeeBasedTollCall implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserSettingsAudioConference_toll_free_and_fee_based_toll_call';
     ...
     * Sets enable
     *
     * @param bool|null $enable Whether the user has the [**Toll-free and Fee-based Toll Call**](https://support.zoom.us/hc/en-us/articles/360060950711-Enabling-Toll-free-and-Fee-based-Toll-Call#h_01F5190TYM8736XHQX683YQYSY) setting enabled.
     *
     * @return self
     */
     ...
     * Sets numbers
     *
     * @param \Zoom\Api\Model\AccountSettingsAudioConferenceTollFreeAndFeeBasedTollCallNumbersInner[]|null $numbers The user's **Toll-free and Fee-based Toll Call** phone number information.
     *
     * @return self
     */
    public function setNumbers($numbers)
    {
        ...
        if (!is_null($numbers) && (count($numbers) > 100)) {
            throw new \InvalidArgumentException('invalid value for $numbers when calling UserSettingsAudioConferenceTollFreeAndFeeBasedTollCall., number of items must be less than or equal to 100.');
        }
