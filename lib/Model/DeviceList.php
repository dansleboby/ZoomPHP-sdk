 ...
 */
class DeviceList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceList';
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling DeviceList., must be smaller than or equal to 300.');
        }
     ...
     * Sets devices
     *
     * @param object[]|null $devices List of H.323/SIP Device objects.
     *
     * @return self
     */
