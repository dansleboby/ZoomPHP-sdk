...
class InlineObject11 implements ModelInterface, ArrayAccess
{
    ...
    public function setFirstName($first_name)
    {
        if ((mb_strlen($first_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling InlineObject11., must be smaller than or equal to 64.');
        }
    ...
    public function setLastName($last_name)
    {
        if ((mb_strlen($last_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling InlineObject11., must be smaller than or equal to 64.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 128)) {
            throw new \InvalidArgumentException('invalid length for $email when calling InlineObject11., must be smaller than or equal to 128.');
        }
     ...
     * Gets options
     *
     * @return \Zoom\Api\Model\AccountsOptions|null
     */
     ...
     * Sets options
     *
     * @param \Zoom\Api\Model\AccountsOptions|null $options options
     *
     * @return $this
     */
     ...
     * Sets account_name
     *
     * @param string|null $account_name Name of the account. If you do not provide a value for this field, by default, the value will be set as a contatenation of \"first_name\" and \"last_name\".
     *
     * @return $this
     */
    public function setAccountName($account_name)
    {
        if (!is_null($account_name) && (mb_strlen($account_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $account_name when calling InlineObject11., must be smaller than or equal to 64.');
        }
