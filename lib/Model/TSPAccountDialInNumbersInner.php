...
/**
 * TSPAccountDialInNumbersInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class TSPAccountDialInNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TSP_Account_dial_in_numbers_inner';
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling TSPAccountDialInNumbersInner., must be smaller than or equal to 6.');
        }
    ...
    public function setCountryLabel($country_label)
    {
        if (!is_null($country_label) && (mb_strlen($country_label) > 10)) {
            throw new \InvalidArgumentException('invalid length for $country_label when calling TSPAccountDialInNumbersInner., must be smaller than or equal to 10.');
        }
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $number when calling TSPAccountDialInNumbersInner., must be smaller than or equal to 16.');
        }
        if (!is_null($number) && (mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling TSPAccountDialInNumbersInner., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param string|null $type Dial-in number types:<br>`toll` - Toll number.<br>`tollfree` -Toll free number. <br> `media_link` - Media link phone number. This is used for PSTN integration instead of a paid bridge number.
     *
     * @return self
     */
