...
/**
 * WebinarRegistrantCreate201Response Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class WebinarRegistrantCreate201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webinarRegistrantCreate_201_response';
     ...
     * Sets id
     *
     * @param string|null $id The webinar's ID.
     *
     * @return self
     */
     ...
     * Sets join_url
     *
     * @param string|null $join_url The URL the registrant can use to join the webinar.
     *
     * @return self
     */
     ...
     * Sets start_time
     *
     * @param \DateTime|null $start_time The webinar's start time.
     *
     * @return self
     */
     ...
     * Sets topic
     *
     * @param string|null $topic The webinar's topic.
     *
     * @return self
     */
    public function setTopic($topic)
    {
        if (!is_null($topic) && (mb_strlen($topic) > 200)) {
            throw new \InvalidArgumentException('invalid length for $topic when calling WebinarRegistrantCreate201Response., must be smaller than or equal to 200.');
        }
