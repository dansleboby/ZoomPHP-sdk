...
/**
 * CreateBatchPolls201ResponsePollsInnerQuestionsInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class CreateBatchPolls201ResponsePollsInnerQuestionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createBatchPolls_201_response_polls_inner_questions_inner';
    ...
    protected static $openAPITypes = [
        ...
        'case_sensitive' => 'bool',
        'name' => 'string',
        'prompts' => '\Zoom\Api\Model\CreateBatchPolls201ResponsePollsInnerQuestionsInnerPromptsInner[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['answer_required'] = $data['answer_required'] ?? null;
        ...
        $this->container['show_as_dropdown'] = $data['show_as_dropdown'] ?? null;
     ...
     *
     * @param int|null $answer_max_character The allowed maximum number of characters. This field only returns for `short_answer` and `long_answer` polls.
     *
     * @return self
     */
     ...
     *
     * @param int|null $answer_min_character The allowed minimum number of characters. This field only returns for `short_answer` and `long_answer` polls.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $answer_required Whether participants must answer the question:  * `true` — The participant must answer the question.  * `false` — The participant does not need to answer the question.
     *
     * @return self
     */
     ...
     * Sets case_sensitive
     *
     * @param bool|null $case_sensitive Whether the correct answer is case sensitive. This field only returns for `fill_in_the_blank` polls:  * `true` — The answer is case-sensitive.  * `false` — The answer is not case-sensitive.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The poll question's title. For `fill_in_the_blank` polls, this field is the poll's question.
     *
     * @return self
     */
     ...
     * Gets prompts
     *
     * @return \Zoom\Api\Model\CreateBatchPolls201ResponsePollsInnerQuestionsInnerPromptsInner[]|null
     */
     ...
     * Sets prompts
     *
     * @param \Zoom\Api\Model\CreateBatchPolls201ResponsePollsInnerQuestionsInnerPromptsInner[]|null $prompts Information about the prompt questions. This object only returns for `matching` and `rank_order` polls.
     *
     * @return self
     */
     ...
     *
     * @param string|null $rating_max_label The high score label used for the `rating_max_value` field. This field only returns for `rating_scale` polls.
     *
     * @return self
     */
     ...
     *
     * @param int|null $rating_max_value The rating scale's maximum value. This field only returns for `rating_scale` polls.
     *
     * @return self
     */
    public function setRatingMaxValue($rating_max_value)
    {
        ...
        if (!is_null($rating_max_value) && ($rating_max_value > 10)) {
            throw new \InvalidArgumentException('invalid value for $rating_max_value when calling CreateBatchPolls201ResponsePollsInnerQuestionsInner., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string|null $rating_min_label The low score label used for the `rating_min_value` field. This field only returns for `rating_scale` polls.
     *
     * @return self
     */
     ...
     *
     * @param int|null $rating_min_value The rating scale's minimum value. This field only returns for `rating_scale` polls.
     *
     * @return self
     */
     ...
     * Sets right_answers
     *
     * @param string[]|null $right_answers The poll question's correct answer(s).
     *
     * @return self
     */
     ...
     *
     * @param bool|null $show_as_dropdown Whether to display the radio selection as a drop-down box:  * `true` — Show as a drop-down box.  * `false` — Do not show as a drop-down box.
     *
     * @return self
     */
