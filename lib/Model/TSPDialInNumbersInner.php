...
/**
 * TSPDialInNumbersInner Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class TSPDialInNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TSP_dial_in_numbers_inner';
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling TSPDialInNumbersInner., must be smaller than or equal to 6.');
        }
    ...
    public function setCountryLabel($country_label)
    {
        if (!is_null($country_label) && (mb_strlen($country_label) > 10)) {
            throw new \InvalidArgumentException('invalid length for $country_label when calling TSPDialInNumbersInner., must be smaller than or equal to 10.');
        }
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $number when calling TSPDialInNumbersInner., must be smaller than or equal to 16.');
        }
        if (!is_null($number) && (mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling TSPDialInNumbersInner., must be bigger than or equal to 1.');
        }
