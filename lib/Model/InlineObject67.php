...
class InlineObject67 implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject67., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineObject67., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 32)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineObject67., must be smaller than or equal to 32.');
        }
     ...
     * Gets members
     *
     * @return \Zoom\Api\Model\PhoneCallQueuesMembers|null
     */
     ...
     * Sets members
     *
     * @param \Zoom\Api\Model\PhoneCallQueuesMembers|null $members members
     *
     * @return $this
     */
