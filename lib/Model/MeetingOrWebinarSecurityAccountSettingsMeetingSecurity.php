...
/**
 * MeetingOrWebinarSecurityAccountSettingsMeetingSecurity Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class MeetingOrWebinarSecurityAccountSettingsMeetingSecurity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Meeting_or_Webinar_Security_Account_Settings_meeting_security';
    ...
    protected static $openAPITypes = [
        ...
        'chat_etiquette_tool' => '\Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettingsMeetingSecurityChatEtiquetteTool',
        'embed_password_in_join_link' => 'bool',
        'encryption_type' => 'string',
        'end_to_end_encrypted_meetings' => 'bool',
        'meeting_password' => 'bool',
        'meeting_password_requirement' => '\Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettingsMeetingSecurityMeetingPasswordRequirement',
     ...
     *
     * @param string[]|null $block_user_domain_list The blocked domains.
     *
     * @return self
     */
    public function setBlockUserDomainList($block_user_domain_list)
    {
        ...
        if (!is_null($block_user_domain_list) && (count($block_user_domain_list) > 20)) {
            throw new \InvalidArgumentException('invalid value for $block_user_domain_list when calling MeetingOrWebinarSecurityAccountSettingsMeetingSecurity., number of items must be less than or equal to 20.');
        }
     ...
     *
     * @return \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettingsMeetingSecurityChatEtiquetteTool|null
     */
     ...
     *
     * @param \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettingsMeetingSecurityChatEtiquetteTool|null $chat_etiquette_tool chat_etiquette_tool
     *
     * @return self
     */
     ...
     *
     * @param bool|null $end_to_end_encrypted_meetings Whether to enable end-to-end encryption for meetings.
     *
     * @return self
     */
     ...
     *
     * @return \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettingsMeetingSecurityMeetingPasswordRequirement|null
     */
     ...
     *
     * @param \Zoom\Api\Model\MeetingOrWebinarSecurityAccountSettingsMeetingSecurityMeetingPasswordRequirement|null $meeting_password_requirement meeting_password_requirement
     *
     * @return self
     */
     ...
     *
     * @param bool|null $require_password_for_scheduled_meeting Whether passwords are required for meetings that have already been scheduled.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $require_password_for_scheduled_webinar Whether passwords are required for webinars that have already been scheduled.
     *
     * @return self
     */
