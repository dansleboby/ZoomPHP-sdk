...
/**
 * UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignage Class Doc Comment
 *
 * @category Class
 * @package  Zoom\Api
 * @author   OpenAPI Generator team
 ...
 */
class UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateZoomRoomAccSettings_request_oneOf_1_digital_signage';
    ...
    protected static $openAPITypes = [
        'banner' => '\Zoom\Api\Model\UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignageBanner',
        'display_period' => '\Zoom\Api\Model\UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignageDisplayPeriod',
        'enable_digital_signage' => 'bool',
        'layout' => 'string',
        'mute' => 'bool',
        'play_list' => '\Zoom\Api\Model\UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignagePlayListInner[]'
    ];
     ...
     * Gets banner
     *
     * @return \Zoom\Api\Model\UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignageBanner|null
     */
     ...
     * Sets banner
     *
     * @param \Zoom\Api\Model\UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignageBanner|null $banner banner
     *
     * @return self
     */
     ...
     * Gets display_period
     *
     * @return \Zoom\Api\Model\UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignageDisplayPeriod|null
     */
     ...
     * Sets display_period
     *
     * @param \Zoom\Api\Model\UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignageDisplayPeriod|null $display_period display_period
     *
     * @return self
     */
     ...
     *
     * @param bool|null $enable_digital_signage [Enable or disable digital signage](https://support.zoom.us/hc/en-us/articles/360000030683-Zoom-Rooms-digital-signage#h_767fbb33-82a8-45a8-8392-a1bfa9687edd). <br> `true`: enable<br> `false`: disable
     *
     * @return self
     */
     ...
     * Gets play_list
     *
     * @return \Zoom\Api\Model\UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignagePlayListInner[]|null
     */
     ...
     * Sets play_list
     *
     * @param \Zoom\Api\Model\UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignagePlayListInner[]|null $play_list Content list.
     *
     * @return self
     */
    public function setPlayList($play_list)
    {
        ...
        if (!is_null($play_list) && (count($play_list) > 2)) {
            throw new \InvalidArgumentException('invalid value for $play_list when calling UpdateZoomRoomAccSettingsRequestOneOf1DigitalSignage., number of items must be less than or equal to 2.');
        }
