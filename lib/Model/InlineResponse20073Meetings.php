...
class InlineResponse20073Meetings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_73_meetings';
     ...
     * Sets uuid
     *
     * @param string|null $uuid Universally Unique Identifier of a meeting instance. Each meeting instance will have its own meeting UUID.
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string|null $id Meeting ID - Unique Identifier for a meeting, also known as Meeting Number.
     *
     * @return $this
     */
     ...
     * Sets host_id
     *
     * @param string|null $host_id User ID of the user who is set as the host of the meeting.
     *
     * @return $this
     */
     ...
     * Sets start_time
     *
     * @param \DateTime|null $start_time The date and time at which the meeting started.
     *
     * @return $this
     */
     ...
     * Sets duration
     *
     * @param int|null $duration The scheduled duration of the meeting.
     *
     * @return $this
     */
     ...
     * Sets total_size
     *
     * @param int|null $total_size The total size of the meeting in bytes.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $recording_count The total number of recordings retrieved from the account.
     *
     * @return $this
     */
     ...
     *
     * @return \Zoom\Api\Model\InlineResponse20073RecordingFiles[]|null
     */
     ...
     *
     * @param \Zoom\Api\Model\InlineResponse20073RecordingFiles[]|null $recording_files Recording files object
     *
     * @return $this
     */
