...
$body = new \Zoom\Api\Model\InlineObject2(); // \Zoom\Api\Model\InlineObject2 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Zoom\Api\Model\InlineObject2**](../Model/InlineObject2.md)|  | [optional]
...
$body = new \Zoom\Api\Model\InlineObject65(); // \Zoom\Api\Model\InlineObject65 | 
 ...
 **body** | [**\Zoom\Api\Model\InlineObject65**](../Model/InlineObject65.md)|  | [optional]
...
$body = new \Zoom\Api\Model\InlineObject83(); // \Zoom\Api\Model\InlineObject83 | 
...
------------- | ------------- | ------------- | -------------
 **id** | **string**| Room ID |
 **body** | [**\Zoom\Api\Model\InlineObject83**](../Model/InlineObject83.md)|  | [optional]
...
$room_id = 'room_id_example'; // string | Unique Identifier of a Zoom Room.
$body = new \Zoom\Api\Model\InlineObject60(); // \Zoom\Api\Model\InlineObject60 | 
...
------------- | ------------- | ------------- | -------------
 **room_id** | **string**| Unique Identifier of a Zoom Room. |
 **body** | [**\Zoom\Api\Model\InlineObject60**](../Model/InlineObject60.md)|  | [optional]
...
> object updateZRSettings($room_id, $setting_type, $body)
...
try {
    $result = $apiInstance->updateZRSettings($room_id, $setting_type, $body);
    print_r($result);
} catch (Exception $e) {
